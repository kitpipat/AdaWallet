            ...
            <table class="table table-striped" style="width:100%">
                <thead>
                    <?php if($aAlwEvent['tAutStaFull'] == 1 || $aAlwEvent['tAutStaDelete'] == 1) : ?>
                        <th nowrap class="xCNTextBold text-center" style="width:8%;"><?php echo language('pos/posedc/posedc','tPosEdcTBChoose')?></th>
                    <?php endif; ?>
                        <th nowrap class="xCNTextBold" style="text-align:center; width:8%;"><?= language('pos/posedc/posedc', 'tPosEdcTBImg') ?></th>
                    ...
                    <?php if(isset($aDataList) && $aDataList['rtCode'] == 1):?>
                        <?php foreach($aDataList['raItems'] AS $key => $aValue):?>
                            <tr class="xCNTextDetail2 xCNPoeEdc" id="otrPosEdc<?php echo $key?>" data-code="<?php echo $aValue['FTEdcCode']?>" data-name="<?php echo $aValue['FTEdcName']?>">
                                ...
                                <?php endif; ?>
                                <td class="text-center" style="padding-right: 10px !important;"><?php echo FCNtHGetImagePageList($aValue['rtImgObj'],'70px'); ?></td>
                                <td nowrap class="text-left"><?php echo $aValue['FTEdcCode'];?></td>
                                <td nowrap class="text-left"><?php echo ($aValue['FTEdcName'] == '') ? '-' : $aValue['FTEdcName'];?></td>
                                <td nowrap class="text-left"><?php echo ($aValue['FTSedModel'] == '') ? '-' : $aValue['FTEdcName'];?></td>
                                <td nowrap class="text-left"><?php echo ($aValue['FTBnkName'] == '') ? '-' : $aValue['FTEdcName'];?></td>

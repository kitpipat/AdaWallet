...
if (isset($aDataPosEdc) && $aDataPosEdc['rtCode'] == '1') {
    ...
    $tImgObj            = $aDataPosEdc['raItems']['rtImgObj'];
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="col-xs-4 col-sm-4">
                    <?php
                    echo FCNtHGetContentUploadImage(@$tImgObj, 'PosEdc', '1');
                    echo FCNtHGetContentChooseColor(@$tImgObj, 'PosEdc');
                    ?>
                </div>
                <div class="col-xs-8 col-sm-8">
                    ...
                    <div id="odvPosEdcCode" class="form-group">
                        ...
                        <div class="validate-input">
                            <input type="text" class="form-control xCNGenarateCodeTextInputValidate" maxlength="5" id="oetPosEdcCode" name="oetPosEdcCode" value="<?php echo @$tPosEdcCode; ?>" data-is-created="" placeholder="<?php echo language('pos/posedc/posedc', 'tPosEdcCode'); ?>" data-validate-required="<?php echo language('pos/posedc/posedc', 'tPosEdcValidateCode'); ?>" data-validate-dublicateCode="<?php echo language('pos/posedc/posedc', 'tPosEdcValidCodeDup'); ?>">
                        </div>
                    </div>
                    ...
                    <div class="<?php if (!FCNbGetIsAgnEnabled()) : echo 'xCNHide';
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control xCNHide" id="oetEDCUsrAgnCode" name="oetEDCUsrAgnCode" value="<?= @$tUsrAgnCode ?>">
                                <input type="text" class="form-control xWPointerEventNone" id="oetEDCUsrAgnName" name="oetEDCUsrAgnName" placeholder="<?php echo language('common/main/main', 'tAgency') ?>" value="<?= @$tUsrAgnName ?>" readonly>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="oetPosEdcName" name="oetPosEdcName" maxlength="100" value="<?php echo @$tPosEdcName; ?>" placeholder="<?php echo  language('pos/posedc/posedc', 'tPosEdcName'); ?>" autocomplete="off" data-validate-required="<?php echo language('pos/posedc/posedc', 'tPosEdcValidateName'); ?>">
                    </div>
                    <div class="form-group">

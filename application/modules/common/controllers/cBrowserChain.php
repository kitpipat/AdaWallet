                ...
                foreach ($aDataTable as $key => $val) :
                    ...
                    if ($tIDCurrent != $val->$tMasterPK) :
                        ...
                        elseif ($CallBackType == 'M') :
                            ...
                            $tDataTable .= '<tr class="xCNTextDetail2 xCNParent'.$val->$tMasterPK .' ' . $tRowActive . ' xCNChain'.$val->$tMasterChain.' " data-code="'.$val->$tMasterPK.'" data-chain="'.$val->$tMasterChain.'" data-level="'.$val->$tMasterLevel.'" onclick="JCNxPushMultiSelection(' . "'" . $val->$tMasterPK . "','" . $tCallBackTextData . "',this" . ')">';
                        else :

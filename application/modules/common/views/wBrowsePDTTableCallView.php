...
<script>
    ...
    $(document).ready(function(){
        ...
        $('.ordBWStaTopPdt').on('click',function(){
            var nBWStaTopPdt = $('input[name="ordBWStaTopPdt"]:checked').val();
            if(nBWStaTopPdt==1){
                $('.xStaTopPdtCout').hide();
                $('.XCNPosition').css('height','155px');
            }else{
                $('.xStaTopPdtCout').show();
                $('.XCNPosition').css('height','210px');
            }
            $('#ohdBWStaTopPdt').val(nBWStaTopPdt);
        });
        var nBWStaTopPdt = $('input[name="ordBWStaTopPdt"]:checked').val();
        if(nBWStaTopPdt==1){
            $('.xStaTopPdtCout').hide();

	...
	<div class="row">
		...
		<?php if ($aAlwEvent['tAutStaFull'] == 1 || $aAlwEvent['tAutStaDelete'] == 1) : ?>
			<div class="col-xs-4 col-md-8 col-lg-8 text-right" style="margin-top:34px;">
				<button class="btn btn-info xWExportPrintSet" id="obtExportPrintSet" onclick="JSnLabPriExportChoose()"><?php echo language('product/settingprinter/settingprinter', 'tLPTBExport') ?></button>

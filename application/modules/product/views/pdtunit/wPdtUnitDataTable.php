                            ...
                            <tr class="text-center otrPdtUnit" id="otrPdtUnit<?php echo $nKey?>" data-code="<?php echo $aValue['rtPunCode']?>" data-name="<?php echo $aValue['rtPunName']?>">
                                ...
                                <td class="text-center">
                                    <label class="fancy-checkbox">
                                        <input id="ocbListItem<?php echo $nKey?>" type="checkbox" class="ocbListItem" name="ocbListItem[]"  <?php if ($aValue['rtFTUsedCode'] > 0) {  echo "disabled"; } ?>>
                                        <span class="<?php if ($aValue['rtFTUsedCode'] > 0) { echo "xCNDisabled"; } ?>" >&nbsp;</span>
                                    </label>
                                </td>
                                <?php endif; ?>
                                ...
                                <?php if($aAlwEventPdtUnit['tAutStaFull'] == 1 || $aAlwEventPdtUnit['tAutStaDelete'] == 1) : ?>
                                <td class=" <?php if ($aValue['rtFTUsedCode'] > 0) { echo "xWTdDisable"; } ?>" ><img class="xCNIconTable xCNIconDel <?php if ($aValue['rtFTUsedCode'] > 0) { echo "xCNDocDisabled"; } ?>" src="<?php echo  base_url().'/application/modules/common/assets/images/icons/delete.png'?>" <?php if ($aValue['rtFTUsedCode'] == 0) { ?> onClick="JSoPdtUnitDel('<?=$nCurrentPage?>','<?php echo $aValue['rtPunCode']?>','<?=$aValue['rtPunName']?>','<?= language('common/main/main','tModalConfirmDeleteItemsYN')?>')" <?php } ?>></td>
                                <?php endif; ?>
                                <?php if($aAlwEventPdtUnit['tAutStaFull'] == 1 || ($aAlwEventPdtUnit['tAutStaEdit'] == 1 || $aAlwEventPdtUnit['tAutStaRead'] == 1))  : ?>

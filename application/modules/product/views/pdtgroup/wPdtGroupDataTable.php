                            ...
                            <tr class="text-center otrPdtGroup" id="otrPdtGroup<?php echo $nKey?>" data-code="<?php echo $aValue['rtPgpCode']?>" data-name="<?php echo $aValue['rtPgpName']?>">
                                ...
                                <td class="text-center">
                                    <label class="fancy-checkbox">
                                        <input id="ocbListItem<?php echo $nKey?>"  <?php echo $tDisabledItem; ?> type="checkbox" class="ocbListItem" name="ocbListItem[]">
                                ...
                                <?php if($aAlwEventPdtGroup['tAutStaFull'] == 1 || $aAlwEventPdtGroup['tAutStaDelete'] == 1 ) : ?>
                                <td class="<?=$tDisableTD?>"><img class="xCNIconTable <?php echo $tDisableImg; ?>" src="<?php echo  base_url().'/application/modules/common/assets/images/icons/delete.png'?>" onClick="JSoPdtGroupDel('<?=$nCurrentPage?>','<?php echo $aValue['rtPgpCode']?>','<?=$aValue['rtPgpName']?>')"></td>
                                <?php endif; ?>
                                <?php if($aAlwEventPdtGroup['tAutStaFull'] == 1 || ($aAlwEventPdtGroup['tAutStaEdit'] == 1 || $aAlwEventPdtGroup['tAutStaRead'] == 1))  : ?>

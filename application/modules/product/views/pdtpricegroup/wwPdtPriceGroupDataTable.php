            ...
            <table id="otbPplDataList" class="table table-striped"> <!-- เปลี่ยน -->
                <thead>
                    <tr>
                        ...
                        <th class="text-center xCNTextBold" style="width:10%;"><?= language('product/pdtpricelist/pdtpricelist','tPPLTBChoose')?></th>
                        <?php endif; ?>
                        ...
                        <?php foreach($aPplDataList['raItems'] AS $nKey => $aValue):?>
                            <tr class="text-center xCNTextDetail2 otrPdtPrice" id="otrPdtPrice<?=$nKey?>" data-code="<?=$aValue['rtPplCode']?>" data-name="<?=$aValue['rtPplName']?>">
                                <?php if($aAlwEventPdtPrice['tAutStaFull'] == 1 || $aAlwEventPdtPrice['tAutStaDelete'] == 1) : ?>
                                    ...
                                    if($aValue['rtPplCodeLef'] != '' || $aValue['rtPplCodeLef2'] != '' || $aValue['rtPplCodeLef3'] != '' || $aValue['rtPplCodeLef4'] != '' ){
                                ...
                                <td class="text-center">
                                    <label class="fancy-checkbox">
                                        <input id="ocbListItem<?=$nKey?>" type="checkbox" class="ocbListItem" name="ocbListItem[]" <?php echo $tDisabledItem; ?>>
                                ...
                                <?php if($aAlwEventPdtPrice['tAutStaFull'] == 1 || $aAlwEventPdtPrice['tAutStaDelete'] == 1) : ?>
                                <td  class="<?=$tDisableTD?>"><img class="xCNIconTable <?php echo $tDisableImg; ?>" src="<?php echo  base_url().'/application/modules/common/assets/images/icons/delete.png'?>" onClick="JSoPdtPriceDel('<?=$nCurrentPage?>','<?=$aValue['rtPplName']?>','<?=$aValue['rtPplCode']?>','<?= language('common/main/main','tModalConfirmDeleteItemsYN')?>')"></td>
                                <?php endif; ?>
                                <?php if($aAlwEventPdtPrice['tAutStaFull'] == 1 || ($aAlwEventPdtPrice['tAutStaEdit'] == 1 || $aAlwEventPdtPrice['tAutStaRead'] == 1))  : ?>

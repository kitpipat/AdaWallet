...
class cProducttransferbrach extends MX_Controller {
	...
	public function __construct() {
            ...
            $this->load->model('document/producttransferbrach/mProducttransferbrach');
    }
    ...
    public function index($nBrowseType,$tBrowseOption){
        ...
        $this->load->view('document/producttransferbrach/wProducttransferbrach',$aData);
    ...
    public function FSvCTBXGetShipAdd(){
        ...
        $aDataShipAdd = $this->mProducttransferbrach->FSaMTFWGetAddress($tBchCode,$tXthShipAdd,$nLangEdit); 
    ...
    public function FSvCTBXGetShpByBch(){
    ...
    public function FSaCTBXEditEvent(){
        try{
            ...
            $aDataMaster = array(
                ...
                'FTBchCode'             => $this->input->post('oetBchCodeStart'),  
                'FTXthBchFrm'          => $this->input->post('oetBchCodeStart'),
                'FTXthWhFrm'            => $this->input->post('ohdWahCodeStart'),
                'FTXthBchTo'             => $this->input->post('oetBchCodeEnd'),
            ...
            $this->db->trans_begin();
            $aStaSdtOrdHD               = $this->mProducttransferbrach->FSaMTFWAddUpdateHD($aDataMaster);
            $aStaEventOrdHDRef          = $this->mProducttransferbrach->FSaMTFWAddUpdateHDRef($aDataHDSpl);
            $aStaEventDocNoInDocTemp    = $this->mProducttransferbrach->FSaMTFWAddUpdateDocNoInDocTemp($aDataWhere);    //Update DocNo ในตาราง Doctemp
    ...
    public function FSaMTFWAddTmpToDT($ptXthDocNo = ''){
        ...
        $aResInsDT      =  $this->mProducttransferbrach->FSaMTFWInsertTmpToDT($aDataWhere);
    ...
    public function FSaMTFWSumDTIntoHD($ptXthDocNo){
        ...
        $aDataDT    =   $this->mProducttransferbrach->FSaMTFWGetDT($aData); //*ลบ Data เก่าออก*/
        ...
        $aDataDT    =   $this->mProducttransferbrach->FSaMTFWUpdateHDFCXthTotal($aDataUpdHD,$tXthDocNo); //*ลบ Data เก่าออก*/
    ...
    public function FSvCTBXEditPdtIntoTableDT(){
        ...
        //Edit Inline
        $aResUpdDTTmpInline     = $this->mProducttransferbrach->FSnMTFWUpdateInlineDTTemp($aDataUpdateDT,$aDataWhere);
    ...
    public function FSnTFWUpdateHD(){
        ...
        //Get ค่า VATRate
        $cVatRate = $this->mProducttransferbrach->FScMTFWGetVatRateFromDoc($tXthDocNo);

        //Get ค่า VAT InOrEx
        $tXthVATInOrEx = $this->mProducttransferbrach->FCNxTFWGetvatInOrEx($tXthDocNo);

        //get จาก DT
        //ยอดรวมก่อนลด
        $cXthTotal          = $this->mProducttransferbrach->FSaMTFWGetHDFCXthTotal($tXthDocNo); 
        //ยอดรวมมีภาษีห้ามลด
        $cXthVatNoDisChg    = $this->mProducttransferbrach->FSaMTFWGetHDFCXthVatNoDisChg($tXthDocNo); 
        // echo "ยอดรวมมีภาษีห้ามลด :".$cXthVatNoDisChg."<br>";
        //ยอดรวมไม่มีภาษีห้ามลด
        $cXthNoVatNoDisChg  = $this->mProducttransferbrach->FSaMTFWGetHDFCXthNoVatNoDisChg($tXthDocNo); 
        // echo "ยอดรวมไม่มีภาษีห้ามลด :".$cXthNoVatNoDisChg."<br>";
        //ยอดมีภาษีลดได้ 
        $cXthVatDisChgAvi   = $this->mProducttransferbrach->FSaMTFWGetHDFCXthVatDisChgAvi($tXthDocNo); 
        // echo "ยอดมีภาษีลดได้ :".$cXthVatDisChgAvi."<br>";
        //ยอดไม่มีภาษีลดได้ 
        $cXthNoVatDisChgAvi = $this->mProducttransferbrach->FSaMTFWGetHDFCXthNoVatDisChgAvi($tXthDocNo); 
        // echo "ยอดไม่มีภาษีลดได้ :".$cXthNoVatDisChgAvi."<br>";
    
        //ข้อมูลการ ลด ชาร์จ
        $aXthDisChgTxt = $this->mProducttransferbrach->FSaMTFWGetHDFTXthDisChgTxt($tXthDocNo); 
        $tDisChgTxt = '';
        if($aXthDisChgTxt != 0){
        ...
        //get จาก HDDis
        //มูลค่ารวมส่วนลด
        $cXthDis            = $this->mProducttransferbrach->FSaMTFWGetHDFCXthDis($tXthDocNo); 
        //มูลค่ารวมส่วนชาร์จ
        $cXthChg            = $this->mProducttransferbrach->FSaMTFWGetHDFCXthChg($tXthDocNo); 

        //ยอดรวมมีภาษีหลังลด FCXthVatDisChgAvi-SUM(HDis.FCXddDisVat-HDis.FCXddChgVat)
        //Get SUM(HDis.FCXddDisVat-HDis.FCXddChgVat)
        $cXthDisRes    = $this->mProducttransferbrach->FSaMTFWGetSUMFCXddDisVatMinusFCXddChgVat($tXthDocNo);
        $cXthVatAfDisChg    = $cXthVatDisChgAvi-$cXthDisRes;
        // echo "ยอดรวมมีภาษีหลังลด :".$cXthVatAfDisChg."<br>";

        //ยอดรวมไม่มีภาษีหลังลด
        $cXthNoVatAfDisChg  = $this->mProducttransferbrach->FSaMTFWGetHDFCXthNoVatAfDisChg($tXthDocNo);
        // echo $cXthNoVatAfDisChg."<br>";

        //ยอดมัดจำ 
        $cFCXthRefAEAmt  = $this->mProducttransferbrach->FSaMTFWGetFCXthRefAEAmt($tXthDocNo);
        ...
        if($oetXthWpTax != ''){
            ...
            $cXthWpTax = $this->mProducttransferbrach->FSaMTFWGetHDFCXthWpTax($tXthDocNo);
        }
        ...
        $aStaUpdOrdHD = $this->mProducttransferbrach->FSaMTFWUpdateOrdHD($Data,$DataWhere); /*ลงตาราง TAPTOrdHD */
    ...
    public function FSvCTBXApprove(){
        ...
        $aStaApv = $this->mProducttransferbrach->FSvMTFWApprove($aDataUpdate); 
    ...
    public function FSvCTBXCancel(){
        ...
        $aStaApv = $this->mProducttransferbrach->FSvMTFWCancel($aDataUpdate); 
    ...
    public function FSaMTFWAddDT(){
        ...
        $aStaEventDelDT =  $this->mProducttransferbrach->FSnMPMTDelPcoDT($this->input->post('oetSearchAll')); //*ลบ Data เก่าออก*/
        ...
        if($nNum != 0){
            foreach ($aDataFile['DTData'] as $key => $value) {
                ...
                $aStaEventOrdHDSpl  = $this->mProducttransferbrach->FSaMTFWAddUpdateOrdDT($value); /*ลงตาราง TAPTOrdDT */
    ...
    public function FSaMTFWAddDTDis(){
        ...
        $aStaEventDelDTDis =  $this->mProducttransferbrach->FSnMPMTDelPcoDTDis($tXthDocNo); //*ลบ Data เก่าออก*/
        ...
        if($nNum != 0){
            ...
            foreach ($aDataFile['DTData'] as $key => $valueDT) {
                ...
                foreach($valueDT['DTDiscount'] as $keyDis => $valueDTDis) {
                    ...
                    $aStaEventOrdDTDis  = $this->mProducttransferbrach->FSaMTFWAddUpdateOrdDTDis($valueDTDis); /*ลงตาราง TAPTOrdDTDis */
                ...
                $aStaUpdDT  = $this->mProducttransferbrach->FSaMTFWUpdateOrdDT($aDTData,$aDTDataWhere); /*Update TAPTOrdDT ใหม่ */
    ...
    public function FSaMTFWAddHDDis(){
        ...
        $aStaEventDelHDDis =  $this->mProducttransferbrach->FSnMPMTDelPcoHDDis($tXthDocNo); //* ลบ Data เก่าออก */
        ...
        if($nNum > 0){
            ...
            foreach ($aDataFile['HDData'] as $key => $value) {
                ...
                $aStaEventOrdHDDis  = $this->mProducttransferbrach->FSaMTFWAddUpdateHDDis($value); /*ลงตาราง TAPTOrdDT*/
    ...
    public function FSvCTBXAddPdtIntoTableDT(){
        ...
        $nCounts    = $this->mProducttransferbrach->FSaMTFWGetCountDTTemp($aDataWhere);
        ...
        for($nI=0;$nI<FCNnHSizeOf($aPdtData);$nI++){
            ...
            $aDataPdtMaster     =   $this->mProducttransferbrach->FSaMTFWGetDataPdt($aDataPdtWhere); // Data Master Pdt
            
            


            
            $nStaInsPdtToTmp    =   $this->mProducttransferbrach->FSaMTFWInsertPDTToTemp($aDataPdtMaster,$aDataPdtWhere);
    ...
    */
    public function FSnCTFWCalulateDTTemp($ptXthDocNo,$ptXthVATInOrEx){
            ...
            //Get DT Tmp
            $aDataDTTmp = $this->mProducttransferbrach->FSaMTFWGetDTTemp($aDataWhere);
            ...
            if($aDataDTTmp['rtCode'] == 1){
                ...
                $aResUpd = $this->mProducttransferbrach->FSnMWTOUpdateDTTemp($aDataDTTmp,$aDataWhere);
    ...
    public function FSaCTBXDeleteEvent(){
        ...
        $aResDel    = $this->mProducttransferbrach->FSnMTFWDel($aDataMaster);
        $aReturn    = array(
    ...
    public function FSvCTBXRemovePdtInDTTmp(){
        ...
        $aResDel = $this->mProducttransferbrach->FSnMTFWDelDTTmp($aDataWhere);
    ...
    public function FSxCTBXAddPage(){
        $this->mProducttransferbrach->FSxMClearPdtInTmp();
        //Get Option Show Decimal  
        $nOptDecimalShow = FCNxHGetOptionDecimalShow(); 
        ...
        $aDataUserGroup = $this->mProducttransferbrach->FStTFWGetShpCodeForUsrLogin($aDataShp); // Get ข้อมูลสาขา และร้านค้าของ User ที่ login
        if($aDataUserGroup==''){
            $tBchCode   = '';
            $tBchName   = '';
            $tMchCode   = '';
        ...
        $this->load->view('document/producttransferbrach/wProducttransferbrachAdd',$aDataAdd);

    }

    public function FSbCheckHaveProductForTransfer(){
        $tDocNo = $this->input->post("tDocNo");
        $nNumPdt = $this->mProducttransferbrach->FSnMTFWCheckPdtTempForTransfer($tDocNo);
        if($nNumPdt>0){
    ...
    public function FSbCheckHaveProductInDT(){
        $tDocNo = $this->input->post("tDocNo");
        $tBchCode = $this->input->post("tBchCode");
        $nNumPdt = $this->mProducttransferbrach->FSnMTFWCheckHaveProductInDT($tDocNo,$tBchCode);
        if($nNumPdt>0){
            echo json_encode(true);
        }else{
            echo json_encode(false);
    ...
    public function FSvCTBXEditPage(){
        // $tXthDocNo = $this->input->post("ptXthDocNo");
        // $aGetInforTwxHD = $this->mProducttransferbrach->FSxMTWFGeTInforTwxHD($tXthDocNo);
        // $aGetInforTwxHDRef = $this->mProducttransferbrach->FSxMTWFGeTInforTwxHDRef($tXthDocNo);
        // $aGetInforTwxDT = $this->mProducttransferbrach->FSxMTWFGeTInforTwxDT($tXthDocNo);
       ...
       //Lang ภาษา
        ...
        //Get Data
        $aResult        = $this->mProducttransferbrach->FSaMTFWGetHD($aDataWhere);       // Data TCNTPdtTbxHD
        $aDataHDRef     = $this->mProducttransferbrach->FSaMTFWGetHDRef($aDataWhere);    // Data TCNTPdtTbxHDRef
        $aDataDT        = $this->mProducttransferbrach->FSaMTFWGetDT($aDataWhere);       // Data TCNTPdtTbxDT
        $aStaIns        = $this->mProducttransferbrach->FSaMTFWInsertDTToTemp($aDataDT,$aDataWhere);    // Insert Data DocTemp
        $aDataEdit = array(
            'nOptDecimalShow'   =>  $nOptDecimalShow,
            'nOptDocSave'       =>  $nOptDocSave,
            'nOptScanSku'       =>  $nOptScanSku,
        ...
        $this->load->view('document/producttransferbrach/wProducttransferbrachAdd',$aDataEdit);
    ...
    public function FSxCTBXDataTable(){
        ...
        $aResList   = $this->mProducttransferbrach->FSaMTBXList($aData);
        $aGenTable  = array(
            'aAlwEvent'     => $aAlwEvent,
            'aDataList'     => $aResList,
            'nPage'         => $nPage,
        ...
        $this->load->view('document/producttransferbrach/wProducttransferwahouseDataTable',$aGenTable);
    }
    ...
    public function FSvCTBXPdtAdvTblLoadData(){
        ...
        $aDataDT        = $this->mProducttransferbrach->FSaMTFWGetDTTempListPage($aDataWhere);
        $aDataDTSum     = $this->mProducttransferbrach->FSaMTFWSumDTTemp($aDataWhere);
        ...
        $this->load->view('document/producttransferbrach/advancetable/wProducttransferbrachPdtAdvTableData',$aData);
    ...
    */
    public function FSvCTBXVatLoadData(){
        ...
        $aDataVatDT     = $this->mProducttransferbrach->FSaMTFWGetVatDTTemp($aDataWhere);
    ...
    */
    ...
    public function FSxCTBXFormSearchList(){
        ...
        $this->load->view('document/producttransferbrach/wProducttransferbrachFormSearchList',$aDataMaster);
    }
    ...
    public function FSvCTBXPdtMultiDeleteEvent(){
        ...
        if($nCount > 1){
            ...
            for($i=0;$i<$nCount;$i++){
                ...
                $aResDel = $this->mProducttransferbrach->FSaMTFWPdtTmpMultiDel($aDataMaster);
            }
    ...
    public function FSxCTBXClearDocTemForChngCdt(){
        ...
        $this->mProducttransferbrach->FSxMTFXClearDocTemForChngCdt(array(
    ...
    public function FSxCTBXCheckViaCodeForApv(){
        ...
        $aResult = $this->mProducttransferbrach->FSxMTWXCheckViaCodeForApv($tDocNo);
        if($aResult){

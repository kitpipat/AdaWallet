...
class cConditionRedeem extends MX_Controller {
    ...
    public function FSoCRDHCallPageEdit(){
        ...
        $aResultCstLev = $this->mConditionRedeem->FSaMRDHGetDataCstLevByID($aData);
    ...
    public function FSoCRDHEventAdd(){
        try{
            ...
            //ระดับลูกค้า
            $aRddClvCode         = $this->input->post('ohdRddClvCode');
            $aRdhClvStaType      = $this->input->post('ohdRdhClvStaType');
          ...
          //สาขา
            ...
            //ระดับลูกค้า
            $aDataConditionRedeemCRClv = [
                'aRddClvCode'     => $aRddClvCode,
                'aRdhClvStaType'  => $aRdhClvStaType,
            ];
            ...
            $this->mConditionRedeem->FSaMRDHAddUpdateConditionRedeemHDCstLev($aDataConditionRedeemCRClv,$aDataConditionRedeemDT);

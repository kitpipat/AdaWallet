                            ...
                            <tr class="text-center xCNTextDetail2 otrPurchaseoeder" id="otrPurchaseoeder<?=$key?>" data-code="<?=$aValue['FTXphDocNo']?>" data-name="<?=$aValue['FTXphDocNo']?>">
                                ...
                                <td>
                                    <?php if ($aValue['FTXphStaPrcStk'] == 1 || $aValue['FTXphStaDoc'] == 3) { ?>
                                        <img class="xCNIconTable" style="width: 17px;" src="<?= base_url() . '/application/modules/common/assets/images/icons/view2.png' ?>" onClick="JSvCallPageCreditNoteEdit('<?= $aValue['FTXphDocNo'] ?>')">
                                    <?php } else { ?>
                                        <img class="xCNIconTable" src="<?= base_url() . '/application/modules/common/assets/images/icons/edit.png' ?>" onClick="JSvCallPageCreditNoteEdit('<?= $aValue['FTXphDocNo'] ?>')">
                                    <?php } ?>
                                </td>
                            <?php endif; ?>
                            </tr>

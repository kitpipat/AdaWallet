...
<div class="panel panel-headline">
	<div class="panel-heading">
		<section id="ostSearchPromotion">
			<div class="row">
				<div class="col-xs-3 col-md-3">
					<div class="form-group">
						<div class="input-group">
							...
							onkeyup="Javascript:if(event.keyCode==13) JSvTopUpVendingCallPagePdtDataTable()" 
							autocomplete="off">
							<span class="input-group-btn">
								<button type="button" class="btn xCNBtnDateTime" onclick="JSvTopUpVendingCallPagePdtDataTable()">
				...
				<a id="oahTFWSearchReset" class="btn xCNBTNDefult xCNBTNDefult1Btn" href="javascript:;" onclick="JSxTopUpVendingClearSearchData()"><?php echo language('common/main/main', 'tClearSearch'); ?></a>
			</div>
			...
			<div class="row hidden" id="odvTFWAdvanceSearchContainer" style="margin-bottom:20px;">
				<div class="col-xs-12 col-md-6 col-lg-6">
					...
					<div class="col-lg-6 col-md-6 col-xs-6 no-padding padding-right-15">
						<div class="form-group">
							<div class="input-group">
								<input class="form-control xCNHide" id="oetBchCodeFrom" value="<?=$tBchCodeDefault;?>" name="oetBchCodeFrom" maxlength="5">
								<input 
								...
								readonly>
								<span class="input-group-btn">
									<button id="obtTFWBrowseBchFrom" <?=$tBrowseBchDisabled;?> type="button" class="btn xCNBtnBrowseAddOn">
					...
					<div class="col-lg-6 col-md-6 col-xs-6 no-padding padding-left-15">
						<div class="form-group">
							<div class="input-group">
								<input class="form-control xCNHide" id="oetBchCodeTo" value="<?=$tBchCodeDefault;?>" name="oetBchCodeTo" maxlength="5">
								<input 
								class="form-control xWPointerEventNone" 
								type="text" 
								id="oetBchNameTo" 
								...
								readonly>
								<span class="input-group-btn">
									<button id="obtTFWBrowseBchTo" type="button" <?=$tBrowseBchDisabled;?> class="btn xCNBtnBrowseAddOn">
										<img src="<?php echo  base_url() . 'application/modules/common/assets/images/icons/find-24.png' ?>">
									</button>
								</span>
							</div>
				...
				<div class="col-xs-12 col-sm-6 col-md-2 col-lg-2">
                    <div class="form-group" style="width: 60%;">
                        ...
                        <button id="oahTFWAdvanceSearchSubmit" class="btn xCNBTNPrimery" style="width:100%" onclick="JSvTopUpVendingCallPagePdtDataTable()"><?php echo language('common/main/main', 'tSearch'); ?></button>
                    </div>
                </div>
			</div>
		</section>
	...
	<div class="panel-body">
		<section id="odvContentTopUpVending"></section>
	</div>
</div>
...
<?php include('script/jTopupFormSearchList.php') ?>

				...
				<div class="row hidden" id="odvTBAdvanceSearchContainer" style="margin-bottom:20px;">
					<div class="col-xs-12 col-md-6 col-lg-6">
						...
						<div class="col-lg-6 col-md-6 col-xs-6 no-padding padding-right-15">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input class="form-control xWPointerEventNone" type="text" id="oetBchNameFrom" name="oetBchNameFrom" value="<?=$tBCHName;?>" placeholder="<?php echo language('document/producttransferbranch/producttransferbranch','tFrom'); ?>" readonly>
						...
						<div class="col-lg-6 col-md-6 col-xs-6 no-padding padding-left-15">
							<div class="form-group">
								...
								<div class="input-group">
									<input class="form-control xCNHide" id="oetBchCodeTo" name="oetBchCodeTo" value="<?=$tBCHCode;?>" maxlength="5">
									<input class="form-control xWPointerEventNone" type="text" id="oetBchNameTo" name="oetBchNameTo" value="<?=$tBCHName;?>" placeholder="<?php echo language('document/producttransferbranch/producttransferbranch','tTo'); ?>" readonly>
									<!-- ถ้า user มีสาขาจะไม่สามารถ Brw ได้ -->
									<span class="input-group-btn" >
					...
					<div class="col-xs-12 col-sm-6 col-md-2 col-lg-2">
						<div class="form-group" style="width: 60%;">
							...
							<button id="obtTBSubmitFrmSearchAdv" class="btn xCNBTNPrimery" style="width:100%" onclick="JSvTransferBchOutCallPageDataTable()"><?php echo language('common/main/main', 'tSearch'); ?></button>
						</div>
					</div>

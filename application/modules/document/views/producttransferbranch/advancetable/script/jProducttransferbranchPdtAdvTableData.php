<script type="text/javascript">
    ...
    function JSnTBXRemovePdtDTTempMultiple(){
        ...
        $('#odvTbxModalDelPdtInDTTempMultiple #ohdConfirmPIDocNoDelete').val('');
        $('#odvTbxModalDelPdtInDTTempMultiple #ohdConfirmPISeqNoDelete').val('');
        $('#odvTbxModalDelPdtInDTTempMultiple #ohdConfirmPIPdtCodeDelete').val('');
        setTimeout(function(){
            $('.modal-backdrop').remove();
            JCNxLayoutControll();
        }, 500);

            ...
            <div class="panel-collapse collapse in" role="tabpanel">
                <div class="panel-body">
                    <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                        ...
                        <textarea class="form-control" id="otaSOFrmInfoOthRmk" name="otaSOFrmInfoOthRmk" rows="6" placeholder="หมายเหตุ"   <?php if($tSOStaApv==2 && $tSOStaDoc != 3 && $nLastSeq==1){ echo ''; }else{ echo 'disabled'; } ?> ><?php echo $tSOFrmRmk?></textarea>
                    </div>

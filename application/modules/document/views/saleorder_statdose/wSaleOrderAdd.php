<?php
    ...
    if(isset($aDataDocHD) && $aDataDocHD['rtCode'] == '1'){
        ...
        $tDepCode               = $aDataDocHD['FTDptCode'];
        $tDepName               = $aDataDocHD['FTDptName'];
        ...
        $tSOPosName             = $aDataDocHD['FTPosName'];
        ...
        $tConfigSystem          = $tConfigSystem; //รูปแบบระบบ

    }else{
        $tSORoute               = "dcmSOEventAdd_STD";
        $nSOAutStaEdit          = 0;
        $tSODocNo               = "";
        $dSODocDate             = "";
...
<form id="ofmSOFormAdd" class="validate-form" action="javascript:void(0)" method="post" enctype="multipart/form-data">
    ...
    <input type="hidden" id="ohdSODptCode" name="ohdSODptCode" value="<?php echo $tDepCode;?>">
    ...
    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input name="oetSOFrmBchName" id="oetSOFrmBchName" class="form-control" value="<?=$tSODataInputBchName?>" type="text" readonly="" placeholder="<?= language('document/saleorder/saleorder', 'tSOLabelFrmBranch') ?>" data-validate-required="<?= language('document/saleorder/saleorder', 'tSOLabelFrmBranch') ?>">
                                    <input name="oetSOFrmBchCode" id="oetSOFrmBchCode" value="<?=$tSODataInputBchCode?>" class="form-control xCNHide" type="text">
                                    <span class="input-group-btn">
                                        <button class="btn xCNBtnBrowseAddOn xCNApvOrCanCelDisabled" id="obtSOBrowseBCH" type="button">
                            ...
                            <!-- Condition ร้านค้า -->
                            <div class="form-group">
                                <label class="xCNLabelFrm"><span style = "color:red">*</span> <?php echo language('document/saleorder/saleorder','tSOLabelFrmShop');?></label>
                                <div class="input-group">
                            ...
                            <div class="form-group">
                                <label class="xCNLabelFrm"><span style = "color:red">*</span> <?php echo language('document/saleorder/saleorder','tSOLabelFrmPos');?></label>
                                <div class="input-group">
                                    <input type="text" class="form-control xCNHide" id="oetSOFrmPosCode" name="oetSOFrmPosCode" maxlength="5" value="<?=$tSOPosCode;?>">
                                    <input type="text" class="form-control xWPointerEventNone" id="oetSOFrmPosName" name="oetSOFrmPosName" lavudate-label="<?=language('document/saleorder/saleorder', 'tSOFrmPosCode');?>" value="<?=$tSOPosName;?>" readonly>
                                    <?php
                                        $tDisabledBtnPos    = "";
                                        if($tSORoute == "dcmSOEventAdd_STD"){
                                            if($tSesUsrLevel == "SHP"){
        ...
        <div class="panel panel-default" style="margin-bottom: 25px;">
            <div id="odvSOCustomerInfo" class="panel-heading xCNPanelHeadColor" role="tab" style="padding-top:10px;padding-bottom:10px;">
                ...
                <input type="hidden" name="oetCstPplCode" id="oetCstPplCode" value="">
                <input Type="hidden" name="oetBchPplCode" id="oetBchPplCode" value="<?=$tBchPplCode?>" >
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-xs-12">
                                ...
                                <!-- เพิ่ม Browser Department -->
                                <!-- Create By Witsarut 10/03/2020 -->
                                <div class="form-group">
                                    <label class="xCNLabelFrm"><?php echo language('document/saleorder/saleorder','tSOLabelDepartment');?></label>
                                    <div class="input-group">
                                        <input type="text" class="form-control xCNHide" id="oetDepCode" name="oetDepCode" maxlength="5" value="<?php echo @$tDepCode?>">
								        <input type="text" class="form-control xWPointerEventNone" id="oetDepName" name="oetDepName" maxlength="100" value="<?php echo @$tDepName?>" readonly>
                                        <span class="input-group-btn">
                                            <button id="oimBrowseDep" type="button" class="btn xCNBtnBrowseAddOn"><img class="xCNIconFind"></button>
                                        </span>
                                    </div>
                                </div>
                        ...
                        <div class="panel-collapse collapse in" role="tabpanel" data-grpname="Condition">
                            <div class="panel-body">
                                <div class="row p-t-10">
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        <label class="xCNLabelFrm"><?=language('document/saleorder/saleorder','tSOCstCode');?></label>
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input
                                                    ...
                                                    value="<?= $tSOCstName;?>"
                                                    placeholder="<?= language('document/saleorder/saleorder','tSOCstCode') ?>"
                                                    readonly
                                                >
                                                <span class="input-group-btn">
...
<!-- ============================================ Modal กรอกเหตุผล ============================================ -->
<div class="modal fade" id="odvSOModalKeyReasonDrug">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header xCNModalHead">
                    <label class="xCNTextModalHeard"><?=language('common/main/main', 'tMNUReason') ?></label>
                </div>
                <div class="modal-body">
                    <span  class="xCNTextModal"><?=language('common/main/main', 'tPleaseKey') ?> <?=language('common/main/main', 'tMNUReason') ?></span>
                    <input type="text"      class="form-control" id="oetReasonPDTDrug"  name="oetReasonPDTDrug" maxlength="200" value="" />
                    <input type="hidden"    class="form-control" id="oetReasonPDTSeq"   name="oetReasonPDTSeq"  value="" />
                    <input type="hidden"    class="form-control" id="oetReasonPDTCode"  name="oetReasonPDTCode" value="" />
                </div>
                <div class="modal-footer">
                    <button onclick="JSxInsertReasoDrugToTmp(true)" type="button" class="btn xCNBTNPrimery">
                        <?php echo language('common/main/main', 'tModalConfirm'); ?>
                    </button>
                    <button type="button" class="btn xCNBTNDefult" data-dismiss="modal">
                        <?php echo language('common/main/main', 'tModalCancel'); ?>

				...
				<div class="row">
					<div class="col-xs-3 col-md-3">
						<div class="form-group">
								...
								<input class="form-control xCNInputWithoutSingleQuote" type="text" id="oetSearchAll" name="oetSearchAll" placeholder="<?= language('document/adjuststockvd/producttransferwahousevd','tTFWFillTextSearch')?>" onkeyup="Javascript:if(event.keyCode==13) JSvCallPageTFWPdtDataTable()" autocomplete="off">
				...
				<div class="row hidden" id="odvTFWAdvanceSearchContainer" style="margin-bottom:20px;">
						...
						<div class="col-lg-6 col-md-6 col-xs-6 no-padding padding-right-15">
							<div class="form-group">
								<div class="input-group">
									...
									<input class="form-control xWPointerEventNone" type="text" id="oetBchNameFrom" value="<?=$tBchNameDefault;?>" name="oetBchNameFrom" placeholder="<?php echo language('document/transferwarehouseout/transferwarehouseout','tFrom'); ?>" readonly>
									<!-- ถ้า user มีสาขาจะไม่สามารถ Brw ได้ -->
									<span class="input-group-btn" >
										<button id="obtTFWBrowseBchFrom" type="button" class="btn xCNBtnBrowseAddOn" <?=$tBrowseBchDisabled;?> >
						...
						<div class="col-lg-6 col-md-6 col-xs-6 no-padding padding-left-15">
							<div class="form-group">
								<div class="input-group">
									...
									<!-- ถ้า user มีสาขาจะไม่สามารถ Brw ได้ -->
									<span class="input-group-btn" >
										<button id="obtTFWBrowseBchTo" type="button" class="btn xCNBtnBrowseAddOn" <?=$tBrowseBchDisabled;?> >
											<img src="<?php echo  base_url().'application/modules/common/assets/images/icons/find-24.png'?>">
										</button>
									</span>
								</div>
					...
					<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                        <div class="form-group">
                            ...
                            <button id="oahTFWAdvanceSearchSubmit" class="btn xCNBTNPrimery pull-right" style="width: 60% !important;margin-top: 27.5px;" onclick="JSvCallPageTFWPdtDataTable()" ><?php echo language('common/main/main', 'tSearch'); ?></button>
                        </div>
                    </div>

                    ...
                    <div class="panel-body xCNPDModlue">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control xCNHide xFhnBchCodeShw" id="oetAdjStkSumBchCode" name="oetAdjStkSumBchCode" maxlength="5" value="<?php echo $tUserBchCode; ?>">
                                <input
                    ...
                    <div class="panel-body xCNPDModlue">
                       ...
                       <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="input100 xCNHide xFhnBchCodeShw" id="oetAdjStkSumWahCode" name="oetAdjStkSumWahCode" maxlength="5" value="<?php echo $tUserWahCode; ?>">

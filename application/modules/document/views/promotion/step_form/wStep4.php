...
<div class="row">
    ...
    <div class="col-md-12 xCNPromotionStep4TableGroupBuyWithPaymentTypeConditionContainer">
        <!--Section : เงื่อนไขพิเศษ - ประเภทการชำระเงิน-->
        <div class="panel panel-default" style="margin-bottom: 10px;">
            <div id="odvHeadAllow" class="panel-heading xCNPanelHeadColor" role="tab" style="padding-top:10px;padding-bottom:10px;">
                <label class="xCNTextDetail1"><?php echo language('document/promotion/promotion', 'tSpecialConditions_PaymentType'); ?></label>
            </div>
            ...
            <div class="panel-collapse collapse in" role="tabpanel">
                <div class="panel-body xCNPDModlue">
                    <?php if(!$bIsApvOrCancel) { ?>
                        <div class="row">
                            <div class="col-md-12">
                                <button class="xCNBTNPrimeryPlus pull-right" id="obtPromotionStep4AddPaymentTypeConditionBtn" onclick="JSxPromotionStep4AddPytConditionPanel()" style="margin-bottom: 10px;">+</button>
                            </div>
                        </div>
                    <?php } ?>    
                    <div class="xCNPromotionStep4TablePaymentTypeCondition"></div>
                    <input type="hidden" id="oetPromotionStep4RcvCode" name="oetPromotionStep4RcvCode">
                    <input type="hidden" id="oetPromotionStep4RcvName" name="oetPromotionStep4RcvName">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="panel-collapse collapse in" role="tabpanel">
                <div class="panel-body xCNPDModlue">
                    <?php if(!$bIsApvOrCancel) { ?>
                        <div class="row">
                            <div class="col-md-12">
                                <button class="xCNBTNPrimeryPlus pull-right" id="obtPromotionStep4AddCustomerLevelConditionBtn" onclick="JSxPromotionStep4AddCstConditionPanel()" style="margin-bottom: 10px;">+</button>
                            </div>
                        </div>
                    <?php } ?>    

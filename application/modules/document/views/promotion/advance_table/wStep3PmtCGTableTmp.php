                ...
                <?php foreach ($aDataList['raItems'] as $key => $aValue) { ?>
                    <tr class="xCNTextDetail2 xCNPromotionStep3PmtCGRow" data-seq-no="<?php echo $aValue['FNPgtSeq']; ?>">
                        ...
                        <td class="text-left">
                            ...
                            <?php } else { ?>
                                <script>
                                    var nPromotionPbyStaBuyCond = $('#ocmPromotionPbyStaBuyCond').val();
                                    if (nPromotionPbyStaBuyCond == 2) {
                                        document.getElementById("oetPgtGetQtyInput").disabled = true;
                                    } else if (nPromotionPbyStaBuyCond == 3) {
                                        document.getElementById("oetPgtGetQtyInput").disabled = true;
                                    } else if (nPromotionPbyStaBuyCond == 6) {
                                        document.getElementById("oetPgtGetQtyInput").disabled = true;
                                    }
                                </script>
                                <!-- <input name="ocmPromotionPbyStaBuyCondStep3" id="ocmPromotionPbyStaBuyCondStep3" class="form-control " type="text" value=""> -->
                                <?php

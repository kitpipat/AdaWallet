<div class="table-responsive">
    <table class="table table-striped xWPdtTableFont" id="otbPromotionStep4CstConditionTable">
        <thead>
            <tr>
                ...
                <th width="60%" class="text-left"><?php echo language('pos/poschannel/poschannel', 'tCstLabelChannelName'); ?></th>
        ...
        <tbody>
            <?php if ($aDataList['rtCode'] == 1) { ?>
                <?php foreach ($aDataList['raItems'] as $key => $aValue) { ?>
                    <tr 
                    class="xCNTextDetail2 xCNPromotionPdtPmtHDCstRow" 
                    data-bch-code="<?php echo $aValue['FTBchCode']; ?>" 
                    data-doc-no="<?php echo $aValue['FTPmhDocNo']; ?>" 
                    data-cst-code="<?php echo $aValue['FTClvCode']; ?>">
                    
                        <td class="text-center"><?php echo $key+1; ?></td>
                        <td class="text-left">
                            <select class="xCNApvOrCanCelDisabledPdtPmtHDCst form-control xCNPromotionStep3PgtStaGetType" onchange="JSxPromotionStep4CstConditionDataTableEditInline(this)">
                        ...
                        <td class="text-left"><?php echo $aValue['FTClvName']; ?></td>
...
<?php if($aDataList['rnAllPage'] > 1) { ?>
    <div class="row xCNPromotionPdtPmtHDCstPage">
        <div class="col-md-6">
...
<?php include('script/jStep4CstConditionTableTmp.php'); ?>
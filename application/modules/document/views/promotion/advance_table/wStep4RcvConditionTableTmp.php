        ...
        <tbody>
            <?php if ($aDataList['rtCode'] == 1) { ?>
                <?php foreach ($aDataList['raItems'] as $key => $aValue) { ?>
                    <tr 
                    class="xCNTextDetail2 xCNPromotionPdtPmtHDRcvRow" 
                    data-bch-code="<?php echo $aValue['FTBchCode']; ?>" 
                    data-doc-no="<?php echo $aValue['FTPmhDocNo']; ?>" 
                    data-rcv-code="<?php echo $aValue['FTRcvCode']; ?>">
                    
                        <td class="text-center"><?php echo $key+1; ?></td>
                        <td class="text-left">
                            <select class="xCNApvOrCanCelDisabledPdtPmtHDRcv form-control xCNPromotionStep3PgtStaGetType" onchange="JSxPromotionStep4RcvConditionDataTableEditInline(this)">
                        ...
                        <td class="text-left"><?php echo $aValue['FTRcvName']; ?></td>
...
<?php if($aDataList['rnAllPage'] > 1) { ?>
    <div class="row xCNPromotionPdtPmtHDRcvPage">
        <div class="col-md-6">
...
<?php include('script/jStep4RcvConditionTableTmp.php'); ?>
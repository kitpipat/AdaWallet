		...
		<section id="ostSearchPromotion">
					...
					<div class ="row">
						<div class="col-xs-12 col-md-2 col-lg-2">
							...
							<div class="form-group">
								<select class="form-control" id="ocmUsedStatus" name="ocmUsedStatus" onchange="JSvPromotionCallPageDataTable()">
			...
			<div class="row hidden" id="odvPromotionAdvanceSearchContainer" style="margin-bottom:20px;">
				...
				<div class="col-xs-12 col-md-3 col-lg-3">
					...
					<div class="form-group">
						<select class="form-control" id="ocmStaDoc" name="ocmStaDoc">
				...
				<!-- <div class="col-xs-12 col-md-3 col-lg-3">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="ocmStaDocAct" name="ocmStaDocAct">
                                <option value='0'><?php echo language('common/main/main', 'tAll'); ?></option>

...
<script type="text/javascript" src="<?php echo base_url() ?>application/modules/document/assets/src/producttransferwahouse/jProducttransferwahouse.js?v=1"></script>

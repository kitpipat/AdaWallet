        ...
        <thead>
          <tr class="xCNCenter">
            ...
            <?php if(@$tXthStaApv == '' && @$tXthStaDoc != 3){ ?>
              ...
              <th class="xWDeleteBtnEditButton"><?= language('document/purchaseorder/purchaseorder','tPOTBEdit')?></th>
            <?php } ?>
            <?php if(!((@$tXthStaApv == '') && @$tXthStaDoc != 3)){ ?>
              <th><?= language('document/purchaseorder/purchaseorder','tPOTBDelete')?></th>
              <th class="xWDeleteBtnEditButton"><?= language('document/purchaseorder/purchaseorder','tPOTBEdit')?></th>
        ...
        <?php if($aDataDT['rtCode'] == 1){?>
            ...
            <?php foreach($aDataDT['raItems'] as $DataTableKey=>$aDataTableVal){?>
                    ...
                    <?php } ?>
                      ...
                      <td nowrap class="text-center <?php if(!((@$tXthStaApv == '') && @$tXthStaDoc != 3)){ echo 'xCNDisabled'; } ?>">
                        <label class="xCNTextLink">
                            <img class="xCNIconTable" src="<?php echo  base_url().'/application/modules/common/assets/images/icons/delete.png'?>" title="Remove" 
                            <?php if(((@$tXthStaApv == '') && @$tXthStaDoc != 3)){?>

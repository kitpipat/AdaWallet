					...
					<div class="panel-body xCNPDModlue">
						...
						<div class="form-group">
							...
							<span>
								<div class="form-group">
									<div class="input-group">
										<input type="text" class="form-control xCNHide xCNInputWithoutSpcNotThai xCNInputWithoutSingleQuote xFhnBchCodeShw" name="oetBchCode" id="oetBchCode" maxlength="5" value="<?php echo $tBchCode ?>">
						...
						<div class="form-group <?= !FCNbGetIsShpEnabled() ? 'xCNHide' : ''; ?>">
							...
							<div class="input-group">
								<input class="form-control xCNHide" id="oetMchCode" name="oetMchCode" maxlength="5" value="<?php echo $tMchCode; ?>">
								<input class="form-control xWPointerEventNone" type="text" id="oetMchName" name="oetMchName" value="<?php echo $tMchName; ?>" readonly>
								<?php
								$tMchBtnDisabled = "";
								if ($tUserLoginLevel == "SHP") {
						...
						<div style="border:1px solid #ccc;position:relative;padding:15px;margin-top:30px;">
							...
							<div class="form-group <?= !FCNbGetIsShpEnabled() ? 'xCNHide' : ''; ?>">
								...
								<div class="input-group">
									<input class="form-control xCNHide" id="oetShpCodeStart" name="oetShpCodeStart" maxlength="5" value="<?php echo $tShpCodeStart; ?>">
									<input class="form-control xWPointerEventNone" type="text" id="oetShpNameStart" name="oetShpNameStart" value="<?php echo $tShpNameStart; ?>" readonly>
									<?php
									$tShpBtnDisabled = "";
							...
							<div class="form-group xCNHide">
								...
								<div class="input-group">
									<input class="form-control xCNHide" id="oetPosCodeStart" name="oetPosCodeStart" maxlength="5" value="<?php echo $tPosCodeStart; ?>">
									<input class="form-control xWPointerEventNone" type="text" id="oetPosNameStart" name="oetPosNameStart" value="<?php echo $tPosNameStart; ?>" readonly>
							...
							<div class="form-group">
								...
								<div class="input-group">
									<input type="text" class="input100 xCNHide xFhnWahCodeShw" id="ohdWahCodeStart" name="ohdWahCodeStart" maxlength="5" value="<?php echo $tWahCodeStart; ?>">
									<input class="form-control xWPointerEventNone" type="text" id="oetWahNameStart" name="oetWahNameStart" value="<?php echo $tWahNameStart; ?>" readonly data-validate-required="<?php echo language('document/producttransferwahouse/producttransferwahouse', 'tTFWWahNameStartRequired'); ?>">
						...
						<div style="border:1px solid #ccc;position:relative;padding:15px;margin-top:30px;">
							...
							<div class="form-group <?= !FCNbGetIsShpEnabled() ? 'xCNHide' : ''; ?>">
								<label class="xCNLabelFrm"><?php echo language('document/producttransferwahouse/producttransferwahouse', 'tTFWShop'); ?></label>
								<div class="input-group">
									<input class="form-control xCNHide" id="oetOldShpCodeEnd" name="oetOldShpCodeEnd" maxlength="5" value="<?php echo $tShpCodeStart; ?>">
									<input class="form-control xCNHide" id="oetShpCodeEnd" name="oetShpCodeEnd" maxlength="5" value="<?php echo $tShpCodeStart; ?>">
									<input class="form-control xWPointerEventNone" type="text" id="oetShpNameEnd" name="oetShpNameEnd" value="<?php echo $tShpNameStart; ?>" readonly>
									<?php
									$tShpBtnDisabled = "";
									if ($tUserLoginLevel == "HQ" || $tUserLoginLevel == "BCH" || ($tUserLoginLevel == "SHP" && $nSesUsrShpCount < 2)) {
										$tShpBtnDisabled = "disabled";
							...
							<div class="form-group xCNHide">
								<label class="xCNLabelFrm"><?php echo language('document/producttransferwahouse/producttransferwahouse', 'tTFWPos'); ?></label>
								<div class="input-group">
									<input class="form-control xCNHide" id="oetOldPosCodeEnd" name="oetOldPosCodeEnd" maxlength="5" value="<?php echo $tPosCodeEnd; ?>">
									<input class="form-control xCNHide" id="oetPosCodeEnd" name="oetPosCodeEnd" maxlength="5" value="<?php echo $tPosCodeEnd; ?>">
									<input class="form-control xWPointerEventNone" type="text" id="oetPosNameEnd" name="oetPosNameEnd" value="<?php echo $tPosNameEnd; ?>" readonly>
									<span class="xWConditionSearchPdt input-group-btn">
							...
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input class="form-control xWPointerEventNone" type="text" id="oetWahNameEnd" name="oetWahNameEnd" value="<?php echo $tWahNameEnd; ?>" readonly data-validate-required="<?php echo language('document/producttransferwahouse/producttransferwahouse', 'tTFWWahCodeEndRequired'); ?>">
									<span class="input-group-btn xWConditionSearchPdt">

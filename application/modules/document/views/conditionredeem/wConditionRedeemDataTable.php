                ...
                <tbody>
                    ...
                    <?php if ($aDataList['rtCode'] == 1) : ?>
                        <?php foreach ($aDataList['raItems'] as $nKey => $aValue) : ?>
                            ...
                            // FTRdhStaDoc
                            if ($aValue['FTRdhStaDoc'] == 3) {
                                $tClassStaDoc = 'text-danger';
                                $tStaDoc = language('common/main/main', 'tStaDoc3');
                            } else if ($aValue['FTRdhStaApv'] == 1) {
                            ...
                            } else if ($aValue['FTRdhStaPrcDoc'] == 0 || $aValue['FTRdhStaPrcDoc'] == '') {
                                $tClassPrcStk = 'text-warning';
                                $tStaPrcDoc = language('common/main/main', 'tStaPrcDoc3');
                            }                      
                            ?>
                            <tr class="text-center xCNTextDetail2 xWRDHDocItems" id="otrCouponSetUp<?php echo $nKey ?>" data-code="<?php echo $aValue['FTRdhDocNo'] ?>" data-name="<?php echo $aValue['FTRdhDocNo'] ?>">
                                ...
                                <?php if ($aAlwEvent['tAutStaFull'] == 1 || $aAlwEvent['tAutStaRead'] == 1 || $aAlwEvent['tAutStaEdit'] == 1) : ?>
                                <td nowrap>
                                    <?php if($aValue['FTRdhStaDoc'] == 3 || $aValue['FTRdhStaApv'] == 1) { ?>
                                            <img class="xCNIconTable" style="width: 17px;" src="<?= base_url('application/modules/common/assets/images/icons/view2.png'); ?>" onClick="JSvRDHCallPageEditDocument('<?php echo $aValue['FTRdhDocNo'] ?>','<?php echo $aValue['FTBchCode'] ?>')">
                                        <?php }else{ ?>
                                            <img class="xCNIconTable" src="<?= base_url('application/modules/common/assets/images/icons/edit.png') ?>" onClick="JSvRDHCallPageEditDocument('<?php echo $aValue['FTRdhDocNo'] ?>','<?php echo $aValue['FTBchCode'] ?>')">
                                    <?php } ?>
                                    </td>
                                <?php endif; ?>
                            <tr>

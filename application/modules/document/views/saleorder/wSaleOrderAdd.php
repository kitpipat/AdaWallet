                                            ...
                                            <label class="xCNLabelFrm"><?php echo language('document/saleorder/saleorder', 'tSOLabelFrmBranch')?></label>
												<div class="input-group">
                                                    <input
														...
														id="oetSOFrmBchCodeOld"
														name="oetSOFrmBchCodeOld"
														maxlength="5"
														value="<?php echo @$tSODataInputBchCode?>"
													>
                                                    <input
														type="text"
														class="form-control xCNHide xWPointerEventNone"
														id="oetSOFrmBchNameOld"
														name="oetSOFrmBchNameOld"
														maxlength="100"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button"  data-dismiss="modal" class="btn xCNBTNDefult" id="obtChangeBCHNotClearTmp" ><?php echo language('common/main/main', 'ยกเลิก');?></button>
                </div>
            </div>
        </div>
    </div>
    ...
    function JCNSearchBarcodePdt(ptTextScan){
        ...
        $.ajax({
            ...
            data: {
                ...
                tWhere            : [' AND PPCZ.FTPdtStaAlwSale = 1  AND PBAR.FTBarStaUse= 1 AND PBAR.FTBarStaAlwSale = 1 AND ( CONVERT(VARCHAR(10),GETDATE(),121) BETWEEN CONVERT(VARCHAR(10), Products.FDPdtSaleStart, 121) AND CONVERT(VARCHAR(10), Products.FDPdtSaleStop, 121) )']
            },
            cache   : false,
            timeout : 0,

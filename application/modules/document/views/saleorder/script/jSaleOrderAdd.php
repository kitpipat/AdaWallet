        ...
        var nStaSession = JCNxFuncChkSessionExpired();
            if(typeof(nStaSession) !== 'undefined' && nStaSession == 1){
                ...
                oSOBrowseBranchOption         = oBranchOption({
                    ...
                    'aArgReturn'        : ['FTBchCode','FTBchName','FTWahCode','FTWahName','FTPplCode'],
                });


                var nRowCount = $('.xWPdtItem').length;
                if(nRowCount >= 1){
        ...
        var oBranchOption = function(poDataFnc){
            ...
            var oOptionReturn       = {
                ...
                GrideView: {
                    ...
                    ColumnsSize         : ['10%', '75%'],
                    DataColumns         : ['TCNMBranch.FTBchCode', 'TCNMBranch_L.FTBchName','TCNMWaHouse_L.FTWahCode','TCNMWaHouse_L.FTWahName','TCNMBranch.FTPplCode'],
                    DataColumnsFormat   : ['', ''],
...
//     }
    ...
    function JSxSetDefauleWahouse(ptData){
        if(ptData == '' || ptData == 'NULL'){
            ...
            $('#oetSOFrmBchCodeOld').val(tResult[0]);
            $('#oetSOFrmBchNameOld').val(tResult[1]);
            $('#oetSOFrmWahCode').val(tResult[2]);
            $('#oetSOFrmWahName').val(tResult[3]);
            $('#ohdSOPplCodeBch').val(tResult[4]);
        }
    }

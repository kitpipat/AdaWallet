            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <?php } ?>
                        <th nowrap class="xCNTextBold text-center" style="width:20%;"><?php echo language('document/card/cardrefund', 'tCardShiftRefundTBBranchCode'); ?></th>
                        <th nowrap class="xCNTextBold text-center" style="width:20%;"><?php echo language('document/card/cardrefund', 'tCardShiftRefundTBDocNo'); ?></th>
                        <th nowrap class="xCNTextBold text-center" style="width:10%;"><?php echo language('document/card/cardrefund', 'tCardShiftRefundTBDocDate'); ?></th>
                        <th nowrap class="xCNTextBold text-center" style="width:10%;"><?php echo language('document/card/cardrefund', 'tCardShiftRefundTBCardNumber'); ?></th>
                        <th nowrap class="xCNTextBold text-center" style="width:10%;"><?php echo language('document/card/cardrefund', 'tCardShiftRefundTBDocStatus'); ?></th>
                    ...
                    <?php if ($aDataList['rtCode'] == 1) : ?>
                        <?php foreach ($aDataList['raItems'] as $key => $aValue) : ?>
                            <?php
                                ...
                                $bIsApvOrCancel = ($aValue['rtCardShiftRefundCshStaPrcDoc'] == 1 || $aValue['rtCardShiftRefundCshStaPrcDoc'] == 2) || ($aValue['rtCardShiftRefundCshStaDoc'] == 3 );
                                ...
                                if ($bIsApvOrCancel) {
                                    ...
                                    $ClassDisabled = '';
                                    $Title = '';
                                    $Onclick = "onclick=JSxCardShiftRefundDocDel('" . $nCurrentPage . "','" . $aValue['rtCardShiftRefundDocNo'] . "','".$aValue['rtCardShiftRefundBchCode']."')";
                                }
                            ?>
                            <tr 
                            class="text-center xCNTextDetail2 otrCardShiftRefund"
                            data-doc-no="<?php echo $aValue['rtCardShiftRefundDocNo']; ?>"
                            data-bch-code="<?php echo $aValue['rtCardShiftRefundBchCode']; ?>">
                                ...
                                <td nowrap class="text-center"><?php echo date('d/m/Y', strtotime(@$aValue['rtCardShiftRefundDocDate'])); ?></td>
                                <td nowrap class="text-left"><?php echo @number_format($aValue['rtCardShiftRefundCshCardQty'], 0); ?></td>
                                <?php
                                $tCshStaDoc = "";
                                $tClassStaDoc = "";
                                //StaDoc
                                if ($aValue['rtCardShiftRefundCshStaDoc'] == 3) {
                                    $tClassStaDoc = 'text-danger';
                                    $tStaDoc = language('common/main/main', 'tStaDoc3');
                                } else if ($aValue['rtCardShiftRefundCshStaApv'] == 1) {
                                ...
                                <?php
                                // $tCshStaPrcDoc = "";
                                // if ($aValue['rtCardShiftRefundCshStaPrcDoc'] == 1) {
                                //     $tClassPrcStk = 'text-success';
                                //     $tStaPrcDoc = language('common/main/main', 'tStaPrcDoc1');
                                // } else if ($aValue['rtCardShiftRefundCshStaPrcDoc'] == 2) {
                                //     $tClassPrcStk = 'text-warning';
                                //     $tStaPrcDoc = language('common/main/main', 'tStaPrcDoc3');
                                // } else if ($aValue['rtCardShiftRefundCshStaPrcDoc'] == 0 || $aValue['rtCardShiftRefundCshStaPrcDoc'] == '') {
                                //     $tClassPrcStk = 'text-warning';
                                //     $tStaPrcDoc = language('common/main/main', 'tStaPrcDoc3');
                                // }
                                ?>
                                ...
                                <?php if ($aAlwEvent['tAutStaFull'] == 1 || $aAlwEvent['tAutStaEdit'] == 1 || $aAlwEvent['tAutStaRead'] == 1) { ?>
                                    <td>
                                        <?php if($bIsApvOrCancel) { ?>
                                            <img class="xCNIconTable" style="width: 17px;" src="<?= base_url('application/modules/common/assets/images/icons/view2.png'); ?>" onClick="JSvCardShiftRefundCallPageCardShiftRefundEdit('<?= $aValue['rtCardShiftRefundDocNo'] ?>')">
                                        <?php }else{ ?>
                                            <img class="xCNIconTable" src="<?= base_url('application/modules/common/assets/images/icons/edit.png') ?>" onClick="JSvCardShiftRefundCallPageCardShiftRefundEdit('<?= $aValue['rtCardShiftRefundDocNo'] ?>')">
                                        <?php } ?>
                                    </td>
                                <?php } ?>
                            </tr>
...
<div class="row">
    ...
    <!-- เปลี่ยน -->
    <div class="col-md-6">
        <div class="xWPageCardShiftRefund btn-toolbar pull-right">
            ...
            <button onclick="JSvCardShiftRefundClickPage('previous')" class="btn btn-white btn-sm" <?php echo $tDisabledLeft ?>>
            ...
            <button onclick="JSvCardShiftRefundClickPage('next')" class="btn btn-white btn-sm" <?php echo $tDisabledRight ?>>
                <!-- เปลี่ยนชื่อ Onclick เป็นของเรื่องนั้นๆ -->

    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="table-responsive">
            <table class="table table-striped"  id="otbSelectCustomerAddress">
                <thead>
                    <tr class="xCNCenter">
                        <th class="xCNTextBold" style="text-align:center; width:50px;"><?=language('document/taxinvoicefc/taxinvoicefc', 'tTAXNum')?></th>
                        <th class="xCNTextBold" style="text-align:center; width:120px;"><?=language('document/taxinvoicefc/taxinvoicefc', 'tTAXNoCustomerName')?></th>

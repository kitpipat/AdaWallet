                ...
                <div class="col-xs-3 col-md-3">
                    <div class="form-group">
                        <div class="input-group">
                            <input class="form-control xCNInputWithoutSingleQuote" type="text" id="oetSearchAll" name="oetSearchAll" placeholder="<?= language('document/adjuststocksub/adjuststocksub', 'tAdjStkSubFillTextSearch') ?>" onkeyup="javascript: if(event.keyCode == 13) {JSvCallPageAdjStkSubPdtDataTable()}" autocomplete="off">
            ...
            <div class="row hidden" id="odvAdjStkSubAdvanceSearchContainer" style="margin-bottom:20px;">
                    ...
                    <div class="col-lg-6 col-md-6 col-xs-6 no-padding padding-right-15">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control xWPointerEventNone" type="text" id="oetBchNameFrom" name="oetBchNameFrom" value="<?=$tBchNameDefault;?>" placeholder="<?php echo language('document/transferwarehouseout/transferwarehouseout', 'tFrom'); ?>" readonly>
                                <!-- ถ้า user มีสาขาจะไม่สามารถ Brw ได้ -->
                                <span class="input-group-btn">
                                    <button id="obtAdjStkSubBrowseBchFrom" type="button" class="btn xCNBtnBrowseAddOn" <?=$tBrowseBchDisabled;?>>
                    ...
                    <div class="col-lg-6 col-md-6 col-xs-6 no-padding padding-left-15">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <!-- ถ้า user มีสาขาจะไม่สามารถ Brw ได้ -->
                                <span class="input-group-btn">
                                    <button id="obtAdjStkSubBrowseBchTo" type="button" class="btn xCNBtnBrowseAddOn" <?=$tBrowseBchDisabled;?>>
                                        <img src="<?php echo base_url() . 'application/modules/common/assets/images/icons/find-24.png' ?>">
                                    </button>
                                </span>
                            </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-2 col-lg-2">
                    <div class="form-group" style="width: 60%;">
                        ...
                        <button id="oahAdjStkSubAdvanceSearchSubmit" class="btn xCNBTNPrimery" style="width:100%"><?php echo language('common/main/main', 'tSearch'); ?></button>
                    </div>
                </div>
            </div>
        </section>

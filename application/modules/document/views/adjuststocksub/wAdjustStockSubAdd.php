                    ...
                    <div class="panel-body xCNPDModlue">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control xCNHide xFhnBchCodeShw" id="ohdAdjStkSubBchCodeTo" name="ohdAdjStkSubBchCodeTo" maxlength="5" value="<?php echo $tAjhBchCodeTo; ?>">
                                <input
                        ...
                        <div class="row" style="margin-top: 10px;">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="input100 xCNHide xFhnWahCodeShw" id="oetAdjStkSubWahCodeTo" name="oetAdjStkSubWahCodeTo" value="<?php echo $tAjhWahCodeTo; ?>">

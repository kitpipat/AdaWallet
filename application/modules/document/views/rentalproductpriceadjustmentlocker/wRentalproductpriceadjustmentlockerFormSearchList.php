				...
				<div class="row">
					<div class="col-xs-3 col-md-3">
						<div class="form-group">
								...
								<input class="form-control xCNInputWithoutSingleQuote" type="text" id="oetSearchAll" name="oetSearchAll" placeholder="<?= language('document/rentalproductpriceadjustmentlocker/rentalproductpriceadjustmentlocker','tTFWFillTextSearch')?>" onkeyup="Javascript:if(event.keyCode==13) JSvCallPageTFWPdtDataTable()" autocomplete="off">
				...
				<div class="row hidden" id="odvTFWAdvanceSearchContainer" style="margin-bottom:20px;">
						...
						<div class="col-lg-6 col-md-6 col-xs-6 no-padding padding-right-15">
							...
							<label class="xCNLabelFrm"><?php echo language('document/adjuststock/adjuststock', 'tASTAdvSearchBranch'); ?></label>
								<div class="input-group">
									...
									<input class="form-control xWPointerEventNone" type="text" id="oetBchNameFrom" name="oetBchNameFrom" value="<?= $tBCHName; ?>" placeholder="<?php echo language('document/transferwarehouseout/transferwarehouseout','tFrom'); ?>" readonly>
						...
						<div class="col-lg-6 col-md-6 col-xs-6 no-padding padding-left-15">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input class="form-control xWPointerEventNone" type="text" id="oetBchNameTo" name="oetBchNameTo" value="<?= $tBCHName; ?>" placeholder="<?php echo language('document/transferwarehouseout/transferwarehouseout','tTo'); ?>" readonly>
									<!-- ถ้า user มีสาขาจะไม่สามารถ Brw ได้ -->
									<span class="input-group-btn" >
					...
					<div class="col-xs-12 col-sm-6 col-md-2 col-lg-2">
						<div class="form-group" style="width: 60%;">
							...
							<button class="btn xCNBTNPrimery" style="width:100%" onclick="JSvCallPageTFWPdtDataTable()"><?php echo language('common/main/main', 'tSearch'); ?></button>
						</div>
					</div>
				</div>
		</section>
...
<?php include('script/jRentalproductpriceadjustmentlockerFormSearchList.php')?>

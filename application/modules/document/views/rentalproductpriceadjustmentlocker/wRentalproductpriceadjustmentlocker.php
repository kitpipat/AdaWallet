			...
			<div class="xCNTFWVMaster">
				<div class="col-xs-12 col-md-6">
					<ol id="oliMenuNav" class="breadcrumb">
						<?php FCNxHADDfavorite('ADJPL/0/0');?> 
						<li id="oliTFWTitle" class="xCNLinkClick" onclick="JSvCallPageTFWList()"><?= language('document/rentalproductpriceadjustmentlocker/rentalproductpriceadjustmentlocker','tTFWTitle')?></li>
						<li id="oliTFWTitleAdd" class="active"><a><?= language('document/rentalproductpriceadjustmentlocker/rentalproductpriceadjustmentlocker','tTFWTitleAdd')?></a></li>
						<li id="oliTFWTitleEdit" class="active"><a><?= language('document/rentalproductpriceadjustmentlocker/rentalproductpriceadjustmentlocker','tTFWTitleEdit')?></a></li>
						...
						<div id="odvBtnAddEdit">
							<div class="demo-button xCNBtngroup" style="width:100%;">
								...
								<?php if($aAlwEvent['tAutStaFull'] == 1 || ($aAlwEvent['tAutStaAdd'] == 1 || $aAlwEvent['tAutStaEdit'] == 1)) : ?>
									<button id="obtTFWPrint" class="btn xCNBTNDefult xCNBTNDefult2Btn" type="button"> <?php echo language('common/main/main', 'tCMNPrint')?></button>
...
<script type="text/javascript" src="<?php echo base_url() ?>application/modules/document/assets/src/rentalproductpriceadjustmentlocker/jRentalproductpriceadjustmentlocker.js"></script>
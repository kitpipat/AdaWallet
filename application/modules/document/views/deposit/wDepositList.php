<div class="panel panel-headline">
	<div class="panel-body">
		<section id="ostSearchPromotion">
			<div class="row">
				<div class="col-xs-3 col-md-3">
					<div class="form-group">
						<div class="input-group">
							...
							onkeyup="Javascript:if(event.keyCode==13) JSvDepositCallPageDataTable()" 
							autocomplete="off">
							<span class="input-group-btn">
								<button type="button" class="btn xCNBtnDateTime" onclick="JSvDepositCallPageDataTable()">
				...
				<a id="oahDepositAdvanceSearch" class="btn xCNBTNDefult xCNBTNDefult1Btn" href="javascript:;"><?php echo language('common/main/main', 'tAdvanceSearch'); ?></a>
				<a id="oahTFWSearchReset" class="btn xCNBTNDefult xCNBTNDefult1Btn" href="javascript:;" onclick="JSxDepositClearSearchData()"><?php echo language('common/main/main', 'tClearSearch'); ?></a>
			</div>

			<div class="row hidden" id="odvDepositAdvanceSearchContainer" style="margin-bottom:20px;">
					...
					<div class="col-lg-6 col-md-6 col-xs-6 no-padding padding-right-15">
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								value="<?= $tBCHName; ?>">
								<span class="input-group-btn">
									<button id="obtDepositBrowseBchFrom" type="button" class="btn xCNBtnBrowseAddOn">
					...
					<div class="col-lg-6 col-md-6 col-xs-6 no-padding padding-left-15">
						...
						<div class="form-group">
							<div class="input-group">
								...
								value="<?= $tBCHName; ?>">
								<span class="input-group-btn">
									<button id="obtDepositBrowseBchTo" type="button" class="btn xCNBtnBrowseAddOn">
										<img src="<?php echo  base_url() . 'application/modules/common/assets/images/icons/find-24.png' ?>">
									</button>
								</span>
							</div>
				...
				<div class="col-xs-12 col-sm-6 col-md-2 col-lg-2">
                    <div class="form-group" style="width: 60%;">
                        ...
                        <button id="oahTFWAdvanceSearchSubmit" class="btn xCNBTNPrimery" style="width:100%" onclick="JSvDepositCallPageDataTable()"><?php echo language('common/main/main', 'tSearch'); ?></button>
                    </div>
                </div>
			</div>
		</section>
	...
	<div class="panel-body">
		<section id="odvDepositContent"></section>
	</div>
</div>
...
<?php include('script/jDepositList.php') ?>
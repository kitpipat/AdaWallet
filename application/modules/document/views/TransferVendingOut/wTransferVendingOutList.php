...
<div class="panel panel-headline">
	<div class="panel-heading">
		<section id="ostSearchPromotion">
			<div class="row">
				<div class="col-xs-3 col-md-3">
					<div class="form-group">
						<div class="input-group">
							...
							onkeyup="Javascript:if(event.keyCode==13) JSxTVOPageDataTable()" 
							autocomplete="off">
							<span class="input-group-btn">
								<button type="button" class="btn xCNBtnDateTime" onclick="JSxTVOPageDataTable()">
				...
				<a id="oahTVOAdvanceSearch" class="btn xCNBTNDefult xCNBTNDefult1Btn" href="javascript:;"><?php echo language('common/main/main', 'tAdvanceSearch'); ?></a>
				<a id="oahTVOSearchReset" class="btn xCNBTNDefult xCNBTNDefult1Btn" href="javascript:;" onclick="JSxTVOClearSearchData()"><?php echo language('common/main/main', 'tClearSearch'); ?></a>
			</div>

			<div class="row hidden" id="odvTVOAdvanceSearchContainer" style="margin-bottom:20px;">
				<div class="col-xs-12 col-md-6 col-lg-6">
					<div class="col-lg-12 col-md-12 col-xs-12 no-padding">
						<label class="xCNLabelFrm"><?php echo language('document/TransferVendingOut/TransferVendingOut', 'tBranch'); ?></label>
					</div>
					<div class="col-lg-6 col-md-6 col-xs-6 no-padding padding-right-15">
						<div class="form-group">
							<div class="input-group">
								...
								placeholder="<?php echo language('document/TransferVendingOut/TransferVendingOut', 'tFrom'); ?>" 
								readonly>
								<span class="input-group-btn">
									<button id="obtTVOBrowseBchFrom" <?=$tBrowseBchDisabled;?> type="button" class="btn xCNBtnBrowseAddOn">
					...
					<div class="col-lg-6 col-md-6 col-xs-6 no-padding padding-left-15">
						<div class="form-group">
							<div class="input-group">
								...
								name="oetBchNameTo" 
								value="<?=$tBchNameDefault;?>"
								placeholder="<?php echo language('document/TransferVendingOut/TransferVendingOut', 'tTo'); ?>" 
								readonly>
								<span class="input-group-btn">
									<button id="obtTVOBrowseBchTo" <?=$tBrowseBchDisabled;?> type="button" class="btn xCNBtnBrowseAddOn">
										<img src="<?php echo  base_url() . 'application/modules/common/assets/images/icons/find-24.png' ?>">
									</button>
								</span>
							</div>
				...
				<div class="col-xs-12 col-md-6 col-lg-6">
					<div class="col-lg-12 col-md-12 col-xs-12 no-padding">
						<label class="xCNLabelFrm"><?php echo language('document/TransferVendingOut/TransferVendingOut', 'tTBDocDate'); ?></label>
					</div>
					<div class="col-lg-6 col-md-6 col-xs-6 no-padding padding-right-15">
						<div class="form-group">
							<div class="input-group">
				...
				<div class="col-xs-12 col-md-3 col-lg-3">
					<div class="col-lg-12 col-md-12 col-xs-12 no-padding">
						<label class="xCNLabelFrm"><?php echo language('document/TransferVendingOut/TransferVendingOut', 'tTBStaDoc'); ?></label>
					</div>
					<div class="form-group">
				...
				<div class="col-xs-12 col-md-3 col-lg-3">
					<div class="col-lg-12 col-md-12 col-xs-12 no-padding">
						<label class="xCNLabelFrm"><?php echo language('document/TransferVendingOut/TransferVendingOut', 'tTBStaPrc'); ?></label>
					</div>
					<div class="form-group">
				...
				<div class="col-xs-12 col-sm-6 col-md-2 col-lg-2">
                    <div class="form-group" style="width: 60%;">
                        ...
                        <button id="oahTVOAdvanceSearchSubmit" class="btn xCNBTNPrimery" style="width:100%" onclick="JSxTVOPageDataTable()"><?php echo language('common/main/main', 'tSearch'); ?></button>
                    </div>
                </div>
			</div>
		</section>
	...
	<div class="panel-body">
		<section id="odvTVOContentPageList"></section>
	</div>
</div>
...
<?php include('script/jTransferVendingOutFormSearchList.php') ?>
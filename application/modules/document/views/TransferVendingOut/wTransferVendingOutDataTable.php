                ...
                <thead>
                    <tr class="xCNCenter">
                        <?php if ($aAlwEvent['tAutStaFull'] == 1 || $aAlwEvent['tAutStaDelete'] == 1) { ?>
                            <th class="xCNTextBold" style="width:5%;"><?= language('document/TransferVendingOut/TransferVendingOut', 'tTBChoose') ?></th>
                        <?php } ?>
                        <th class="xCNTextBold"><?= language('document/TransferVendingOut/TransferVendingOut', 'tTBBchCreate') ?></th>
                        <th class="xCNTextBold"><?= language('document/TransferVendingOut/TransferVendingOut', 'tTBDocNo') ?></th>
                        <th class="xCNTextBold"><?= language('document/TransferVendingOut/TransferVendingOut', 'tTBDocDate') ?></th>
                        <th class="xCNTextBold"><?= language('document/TransferVendingOut/TransferVendingOut', 'tTBStaDoc') ?></th>
                        <!-- <th class="xCNTextBold"><?= language('document/TransferVendingOut/TransferVendingOut', 'tTBStaApv') ?></th> -->
                        <th class="xCNTextBold"><?= language('document/TransferVendingOut/TransferVendingOut', 'tTBStaPrc') ?></th>
                        <th class="xCNTextBold"><?= language('document/TransferVendingOut/TransferVendingOut', 'tTBCreateBy') ?></th>
                        <th class="xCNTextBold"><?= language('document/TransferVendingOut/TransferVendingOut', 'tTBApvBy') ?></th>
                        <?php if ($aAlwEvent['tAutStaFull'] == 1 || $aAlwEvent['tAutStaDelete'] == 1) { ?>
                    ...
                    <?php if ($aDataList['rtCode'] == 1) { ?>
                        <?php foreach ($aDataList['raItems'] as $key => $aValue) { ?>
                            ...
                            if ($aValue['FTXthStaApv'] == 1 || $aValue['FTXthStaApv'] == 2 || $aValue['FTXthStaDoc'] == 3) {
                                ...
                                $ClassDisabled = '';
                                $Title = '';
                                $Onclick = "onclick=JSxTVODel('" . $nCurrentPage . "','" . $tXthDocNo . "')";
                            }
                            ...
                            <tr class="text-center xCNTextDetail2 otrPurchaseoeder" id="otrPurchaseoeder<?= $key ?>" data-code="<?= $aValue['FTXthDocNo'] ?>" data-name="<?= $aValue['FTXthDocNo'] ?>">
                                ...
                                <!-- <td class="text-left"><label class="xCNTDTextStatus <?= $tClassStaApv ?>"><?= language('document/TransferVendingOut/TransferVendingOut', 'tStaApv' . $aValue['FTXthStaApv']) ?></label></td> -->
                                ...
                                <?php
                                $tApvName = language('document/TransferVendingOut/TransferVendingOut', 'tNotFound');
                                ...
                                <?php if ($aAlwEvent['tAutStaFull'] == 1 || $aAlwEvent['tAutStaRead'] == 1) { ?>
                                    <td>
                                        <?php if($aValue['FTXthStaApv'] == 1 || $aValue['FTXthStaDoc'] == 3){ ?>
                                            <img class="xCNIconTable" style="width: 17px;" src="<?php echo  base_url().'/application/modules/common/assets/images/icons/view2.png'?>" onClick="JSvTVOCallPageEdit('<?php echo $aValue['FTXthDocNo']?>')">
                                        <?php }else{ ?>
                                            <img class="xCNIconTable" src="<?php echo  base_url().'/application/modules/common/assets/images/icons/edit.png'?>" onClick="JSvTVOCallPageEdit('<?php echo $aValue['FTXthDocNo']?>')">
                                        <?php } ?>
                                    </td>
                                <?php } ?>
                            </tr>
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="xWPage btn-toolbar pull-right">
            ...
            <button onclick="JSxTVODataTableClickPage('previous')" class="btn btn-white btn-sm" <?php echo $tDisabledLeft ?>>
            ...
            <?php for ($i = max($nPage - 2, 1); $i <= max(0, min($aDataList['rnAllPage'], $nPage + 2)); $i++) { ?>
                ...
                ?>
                <button onclick="JSxTVODataTableClickPage('<?php echo $i ?>')" type="button" class="btn xCNBTNNumPagenation <?php echo $tActive ?>" <?php echo $tDisPageNumber ?>><?php echo $i ?></button>
            <?php } ?>
            ...
            <button onclick="JSxTVODataTableClickPage('next')" class="btn btn-white btn-sm" <?php echo $tDisabledRight ?>>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button id="osmConfirm" onClick="JSxTVODelChoose()" class="btn xCNBTNPrimery xCNBTNPrimery2Btn" type="button">

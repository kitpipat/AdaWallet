...
<div class="">
    <div class="table-responsive xCNTablescroll">
        ...
        <input type="text" class="xCNHide" id="ohdEditInlinePdtCode" value="">
        <input type="text" class="xCNHide" id="ohdEditInlinePunCode" value="">
        <table id="otbTbxDocPdtAdvTableList" class="table xWPdtTableFont">
            ...
            <tbody id="odvTBodyPIPdtAdvTableList">
                <?php
                    ...
                    foreach($aDataList['raItems'] as $DataTableKey => $aDataTableVal):
                ...
                ?>
                        <tr class="otr<?=$tUnixPdtCodeRow;?> xWPdtItem xWPdtItemList<?=$nKey?>"
                            data-index="<?php echo $aDataTableVal['FNRowID'];?>"
                        ...
                        >
                            ...
                            <td nowrap align="center"><?=$aDataTableVal['FNRowID']?></td>
                            ...
                            <td nowrap="" class="text-center xCNPIBeHideMQSS">
                                <label class="xCNTextLink">
                                    <img class="xCNIconTable xCNIconDel" src="application/modules/common/assets/images/icons/delete.png" title="Remove" >
                                </label>
                            </td>
                        </tr>
                    <?php
...
<script>
    ...
    $( document ).ready(function() {
        ...
        JSxRendercalculate();
        JSxEditQtyAndPrice();
        if($('#ohdTransferBchOutStaApv').val()==1){
            $('.xCNBTNPrimeryDisChgPlus').hide();
            $(".xCNIconTable").addClass("xCNDocDisabled");
            $(".xCNIconTable").attr("onclick", "").unbind("click");
            $(".xCNTransferBchOutBtnBrowsePdt").attr("disabled", true).addClass("xCNBrowsePdtdisabled");
    ...
    function  FSvTBONextFuncB4SelPDT(ptPdtData){
        ...
        for(var i=0;i<aPackData.length;i++){
            ...
            JSvTransferBchOutInsertPdtToTemp(aNewPackData);   // Insert Database
...
function JSvTransferBchOutInsertPdtToTemp_PDTSerialorFashion(ptPdtDataFhn){
//   console.log(ptPdtDataFhn);
 ...
 var tOptionAddPdt = $('#ocmTransferBchOutOptionAddPdt').val();
  $.ajax({
      type: "POST",
      url: "docTBOEventAddPdtIntoDTFhnTemp",
      data: {
          'tTBODocNo'         : ptXthDocNoSend,
          'tTBOPdtDataFhn'    : ptPdtDataFhn,
          'tTBOBCH'           : $('#oetTransferBchOutBchCode').val(),
          'tTBOType'          : 'PDT',
          'nEvent'            : 1,
...
function FSvTBOPDTEditPdtIntoTableDT_PDTSerialorFashion(ptPdtDataFhn){
    console.log(ptPdtDataFhn);
    var aData = JSON.parse(ptPdtDataFhn);
  var ptXthDocNoSend = "";
  if ( $("#ohdTBRoute").val() == "docTransferBchOutEventEdit" ) {
  ...
  $.ajax({
    ...
    function FSvTBXAddPdtIntoDocDTTempScan(ptPdtData){
        ...
        for(var i=0; i<nLen; i++){
            ...
            var nVat            = (parseFloat($('#ohdTransferBchOutVatRate').val())).toFixed(2);                               //ภาษีจากผู้จำหน่าย
            ...
            var InfoOthReAddPdt = $('#ocmTransferBchOutOptionAddPdt').val();
            ...
            if(tDuplicate == true && InfoOthReAddPdt==1){
                ...
                if(tPdtforSys!='FH'){
                    ...
                    var oQty = '<div class="xWEditInLine'+nKey+'">';
                        ...
                        var  aOptionFashion   = {
                            'tDocumentBranch' : $('#oetTransferBchOutBchCode').val(),
                            'tDocumentNumber' : $('#oetTransferBchOutDocNo').val(),
            ...
            //    var aNewPackData = 'JSxUpdateProductSerialandFashion('+aNewPackData+')';
               var  oQty = '<div class="xWEditInLine'+nKey+'">';       
                ...
                tHTML += '      <img class="xCNIconTable" src="application/modules/common/assets/images/icons/delete.png" title="Remove" onclick="JSxTransferBchOutPdtDataTableDeleteBySeq(this)">';
                tHTML += '  </label>';
                tHTML += '</td>';
                tHTML += '</tr>';
                nKey++;
    ...
    function FSxTBXSelectMulDel(ptElm){
        ...
        let tTbxDocNo    = $('#oetTransferBchOutDocNo').val();
        ...
        let oLocalItemDTTemp    = localStorage.getItem("LocalTransferBchOutPdtItemData");
        let oDataObj            = [];
        if(oLocalItemDTTemp){
            oDataObj    = JSON.parse(oLocalItemDTTemp);
        }
        let aArrayConvert   = [JSON.parse(localStorage.getItem("LocalTransferBchOutPdtItemData"))];
        ...
        if(aArrayConvert == '' || aArrayConvert == null){
            ...
            localStorage.setItem("LocalTransferBchOutPdtItemData",JSON.stringify(oDataObj));
            JSxTBXTextInModalDelPdtDtTemp();
        }else{
            var aReturnRepeat   = JStTBOFindObjectByKey(aArrayConvert[0],'tSeqNo',tTbxSeqNo);
    ...
    function JSxAddScollBarInTablePdt(){
        ...
        if(rowCount >= 7){
            ...
            $('html, body').animate({
             scrollTop: ($("#oetTboInsertBarcode").offset().top)-80
         }, 0);
        }
    ...
    function JSxCalculateVat(){
        ...
        $('#otbTbxDocPdtAdvTableList tbody tr').each(function(){
            ...
            var tTypeVat = $('#ohdTransferBchOutVatInOrEx').val();

<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        // ค้นหาจากสาขา
        // if(tUsrBchCode  != ""){ 
        //     $('#oetASTBchCodeFrom').val(tUsrBchCode);
        //     $('#oetASTBchNameFrom').val(tUsrBchName);
        // }

        // //ค้นหาถึงสาขา
        // if(tUsrBchCode  != ""){ 
        //     $('#oetASTBchCodeTo').val(tUsrBchCode);
        //     $('#oetASTBchNameTo').val(tUsrBchName);
        // }
    ...
    // ======================= Option Branch Advance Search =======================
        ...
        // function default Branch From  and To

                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <div class="">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control xCNHide xCNInputWithoutSpcNotThai xCNInputWithoutSingleQuote xFhnBchCodeShw" id="oetSOFrmBchCode" name="oetSOFrmBchCode" maxlength="5" value="<?php echo $tTWODataInputBchCode; ?>">
                                        ...
                                        <span class="input-group-btn">
                                            <button id="obtBrowseTWOBCH" type="button" class="btn xCNBtnBrowseAddOn xCNApvOrCanCelDisabled"
                                                <?php if ($tTWORoute != "dcmTWOEventAdd") { echo 'disabled'; } ?>
                                            >
                                        ...
                                        <fieldset class="scheduler-border">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="oetTROutWahFromCode" id="oetTROutWahFromCode" value="<?= $tTWOWhFrm ?>" class="form-control xCNHide xFhnWahCodeShw" type="text">
                                                    <span class="input-group-btn">

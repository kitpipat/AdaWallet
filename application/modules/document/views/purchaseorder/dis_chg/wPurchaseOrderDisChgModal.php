<input type="hidden" id="ohdPODisChgType">
<div class="modal fade" id="odvPODisChgPanel" style="max-width: 1500px; margin: 1.75rem auto; width: 85%;">
    <div class="modal-dialog" style="width: 100%;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="btn-group pull-right" style="margin-bottom: 20px; width: 300px;">
                            <button 
                                ...
                                onclick="JCNvPOAddDisChgRow()" 
                                style="width: 100%;"><?php echo language('document/purchaseorder/purchaseorder','tPOMDAddEditDisChg') ?></button>
                        </div>
                    </div>
                </div>
                <!-- Ref DisChg HD Table -->
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div id="odvPODisChgHDTable"></div>
                    </div>
                </div>
                <!-- Ref DisChg DT Table -->
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div id="odvPODisChgDTTable"></div>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <button onclick="JSxPODisChgSave()" type="button" class="btn xCNBTNPrimery">
...
<script type="text/html" id="oscPOTrBodyTemplate">
    <tr class="xWPIDisChgTrTag">
        ...
        <td nowrap style="padding-left: 5px !important;">
            <div class="form-group" style="margin-bottom: 0px !important;">
                <select class="dischgselectpicker form-control xWPIDisChgType" onchange="JSxPOCalcDisChg(this); JCNxPODisChgSetCreateAt(this);">
        ...
        <td nowrap style="padding-left: 5px !important;">
            <div class="form-group" style="margin-bottom: 0px !important;">
                <input 
                    ...
                    onkeyup="javascript:if(event.keyCode==13) JSxPOCalcDisChg(this); JCNxPODisChgSetCreateAt(this)"
                    type="text">
            </div>
        </td>
...
<?php include('script/jPurchaseOrderDisChgModal.php'); ?>
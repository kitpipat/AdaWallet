<script>
    ...
    function JSvTRNCallPageTransferReceiptDataTable(pnPage){
        ...
        $.ajax({
            type    : "POST",
            url     : "TWITransferReceiptDataTable",
            data    : {
    ...
    function JSvTWICallPageEdit(ptDocNumber) {
        try{
            ...
            if(typeof(nStaSession) !== 'undefined' && nStaSession == 1){
                ...
                $.ajax({
                    type    : "POST",
                    url     : "TWITransferReceiptPageEdit",
    ...
    function JSvTRNLoadPdtDataTableHtml(pnPage){
        ...
        if(typeof nStaSession !== "undefined" && nStaSession == 1){
            ...
            $.ajax({
                type    : "POST",
                url     : "TWITransferReceiptPdtAdvanceTableLoadData",
                data: {
    ...
    function JSoTWIDelDocSingle(ptCurrentPage,ptTWIDocNo){
        ...
        if(typeof nStaSession !== "undefined" && nStaSession == 1){
            ...
            $('#odvTWIModalDelDocSingle #osmTWIConfirmPdtDTTemp ').unbind().click(function(){
                ...
                $.ajax({
                    type    : "POST",
                    url     : "TWITransferReceiptEventDelete",
    ...
    function JSxTRNTransferReceiptDocCancel(pbIsConfirm) {
        ...
        if (pbIsConfirm) {
            $.ajax({
                type    : "POST",
                url     : "TWITransferReceiptEventCencel",
                data    : {
                    tTWIDocNo   : tTWIDocNo
                },
                cache   : false,
        ...
        if(typeof nStaSession !== "undefined" && nStaSession == 1){
            try{
                if(pbIsConfirm) {
                    ...
                    $.ajax({
                        type    : "POST",
                        url     : "TWITransferReceiptEventApproved",
                        data: {
                            tXthDocNo   : tXthDocNo,

            ...
            <table class="table table-striped">
                <thead>
                    <tr class="xCNCenter">
                        ...
                        <th class="xCNTextBold"><?=language('document/transferreceiptNew/transferreceiptNew','tTWIDocNo')?></th>
                        <th class="xCNTextBold"><?=language('document/transferreceiptNew/transferreceiptNew','tTWITablePDTBch')?></th>
                        <th class="xCNTextBold"><?=language('document/transferreceiptNew/transferreceiptNew','tTWITablePDTShp')?></th>
                        <th class="xCNTextBold"><?=language('document/transferreceiptNew/transferreceiptNew','tTWITablePDTName')?></th>
                        <th class="xCNTextBold"><?=language('document/transferreceiptNew/transferreceiptNew','tTWITablePDTCode')?></th>
                        <th class="xCNTextBold"><?=language('document/transferreceiptNew/transferreceiptNew','tTWITablePDTUnit')?></th>
                    </tr>
                </thead>
                <tbody id="odvRGPList">
...
<script>
    ...
    $('#osmConfirmPDTCN').click(function() {
        ...
        var ptXthDocNoSend = $("#oetTWIDocNo").val();
        if(aItem.length != 0){
            JCNxOpenLoading();
            $.ajax({
                type    : "POST",
                ...
                data    : {
                    ...
                    'tTWIPdtData'        : JSON.stringify(aItem),

...
<div class="row">
    ...
    <div class="table-responsive" style="min-height: 300px; max-height: 300px; overflow-y: scroll;">
            <table id="otbRSDisChgDataDocDTList" class="table">
                <thead>
                    <tr class="xCNCenter">
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        <?php $tHideClass = ''; ?>
                    <?php endif;?>
                        <tr id="otrRSDisChgDTNotFound" class="<?php echo $tHideClass;?>"><td class='text-center xCNTextDetail2' colspan='100%'><?php echo language('common/main/main','tCMNNotFoundData')?></td></tr>
                </tbody>
            </table>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
            <div class="xWPage btn-toolbar pull-right">
                ...
                <button onclick="JSvRSDisChgDTClickPage('previous')" class="btn btn-white btn-sm" <?php echo $tDisabledLeft ?>>
                ...
                <?php for($i=max($nPage-2, 1); $i<=max(0, min($aDataList['rnAllPage'],$nPage+2)); $i++){?>
                    ...
                    ?>
                    <button onclick="JSvRSDisChgDTClickPage('<?php echo $i?>')" type="button" class="btn xCNBTNNumPagenation <?php echo $tActive ?>" <?php echo $tDisPageNumber ?>><?php echo $i?></button>
                <?php } ?>

                <?php if($nPage >= $aDataList['rnAllPage']){  $tDisabledRight = 'disabled'; }else{  $tDisabledRight = '-';  } ?>
                <button onclick="JSvRSDisChgDTClickPage('next')" class="btn btn-white btn-sm" <?php echo $tDisabledRight ?>>

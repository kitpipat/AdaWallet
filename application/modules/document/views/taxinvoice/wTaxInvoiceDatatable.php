                    ...
                    <?php if($aGetDT['rtCode'] == 1):?>
                        <?php foreach($aGetDT['raItems'] as $nKey => $aValue): ?>
                            <tr class="text-center xCNTextDetail2">  
                                ...
                                <td class="text-right"><label><?=number_format($aValue['FCXsdQty'],$nOptDecimalShow)?></label></td>
                                <td class="text-right"><label><?=number_format($aValue['FCXsdDis'] + $aValue['FCXsdChg'],$nOptDecimalShow)?></label></td> <!-- +$aValue['DISPMT'] -->
                                <td class="text-right"><label><?=number_format($aValue['FCXsdNet'],$nOptDecimalShow)?></label></td> <!-- - $aValue['DISPMT'] -->
                            </tr>
                        <?php endforeach;?>
                    <?php else:?>

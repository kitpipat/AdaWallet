    ...
    if(typeof(nStaSession) !== 'undefined' && nStaSession == 1){
        ...
        $.ajax({
            ...
            data: {
                ...
                'Where'           : [" AND Products.FTPdtType <> '6' AND PPCZ.FTPdtStaAlwSale = 1  AND PBAR.FTBarStaUse= 1 AND PBAR.FTBarStaAlwSale = 1 AND ( CONVERT(VARCHAR(10),GETDATE(),121) BETWEEN CONVERT(VARCHAR(10), Products.FDPdtSaleStart, 121) AND CONVERT(VARCHAR(10), Products.FDPdtSaleStop, 121) )"]
            },
            cache: false,
            timeout: 0,
            success: function(tResult){
...
function JSxSPASearchFromBarcode(poElem){
    ...
    $.ajax({
        ...
        data: {
            ...
            tWhere           : [" AND Products.FTPdtType <> '6' AND PPCZ.FTPdtStaAlwSale = 1  AND PBAR.FTBarStaUse= 1 AND PBAR.FTBarStaAlwSale = 1 AND ( CONVERT(VARCHAR(10),GETDATE(),121) BETWEEN CONVERT(VARCHAR(10), Products.FDPdtSaleStart, 121) AND CONVERT(VARCHAR(10), Products.FDPdtSaleStop, 121) )"]
        },
        cache   : false,
        timeout : 0,
        success : function(tResult){

        ...
        $.ajax({
            ...
            success: function(tResult) {
                ...
                var oOptionForFashion = {
                    'bListItemAll'  : false,
                    'tSpcControl'  : 0,
                    'tNextFunc' : 'FSvPDTAddPdtIntoTableDT'
                }
...
function FSvPDTAddPdtIntoTableDT_PDTSerialorFashion(ptPdtDataFhn){
    ...
    $.ajax({
        type: "POST",
        url: "docTFWEventAddPdtIntoDTFhnTemp",
        data: {
            'tTFWDocNo'         : ptXthDocNoSend,
            'tTFWPdtDataFhn'    : ptPdtDataFhn,
            'tTFWBCH'           : $('#oetBchCode').val(),
            'tTFWType'          : 'PDT',
            'nEvent'           : 1,
            'tOptionAddPdt'    : 1
        },
...
// Create By: Napat(Jame) 13/05/2021
function FSvPDTEditPdtIntoTableDT_PDTSerialorFashion(ptPdtDataFhn){
    console.log(ptPdtDataFhn);
    var aData = JSON.parse(ptPdtDataFhn);
    var ptXthDocNoSend = "";
    if ($("#ohdTFWRoute").val() == "TFWEventEdit") {

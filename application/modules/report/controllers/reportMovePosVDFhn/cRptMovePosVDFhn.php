...
class cRptMovePosVDFhn extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportMovePosVDFhn/mRptMovePosVdFhn');
    ...
    private function init()
    {
        $this->aText = [
            // Title
            'tTitleReport' => language('report/report/report', 'tRptTitleMoveVDFhn'),
    ...
    public function index()
    {
        ...
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->mRptMovePosVdFhn->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase)
    {
        ...
        $aDataReport = $this->mRptMovePosVdFhn->FSaMGetDataReport($aDataWhereRpt);
        ...
        $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/rptMovePosVDFhn', 'wRptMovePosVDFhnHtml', $aDataViewPdt);
    ...
    public function FSoCChkDataReportInTableTemp($paDataSwitchCase)
    {
        try {
            ...
            $nDataCountPage = $this->mRptMovePosVdFhn->FSnMCountDataReportAll($aDataCountData);
    ...
    public function FSvCCallRptRenderExcel()
    {
        ...
        $aCells = [
            ...
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tFTBarCode')),
            WriterEntityFactory::createCell(null),
            ...
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                ...
                if (($nKey + 1) == FCNnHSizeOf($aDataReport['aRptData'])) { //SumFooter
                    ...
                    $values = [
                        ...
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($nFCStkQtySale*-1)),
                        WriterEntityFactory::createCell(null),

...
class cRptAdjustCashInCard extends MX_Controller {
    ...
    public function  FSvCCallRptRenderExcel(){
        ...
        $aCells = [
            WriterEntityFactory::createCell($this->aText['tRPC4TBTxnPosCode']),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell($this->aText['tRPC4TBTxnDocDate']),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell($this->aText['tRPC4TBCardCode']),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell($this->aText['tRPC4TBCardName']),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell($this->aText['tRPC4TBTxnValue']),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell($this->aText['tRPC4TBCvdRmk']),
            WriterEntityFactory::createCell(null),
        ...
        if(isset($aDataReport['raItems']) && !empty($aDataReport['raItems'])) {
            foreach ($aDataReport['raItems'] as $nKey => $aValue) {
                ...
                $values= [
                    ...
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(date("d/m/Y H:i:s", strtotime($aValue['FDTxnDocDate']))),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FTCrdCode']),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FTCrdName']),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCTxnValue']),$oStyle),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FTCdtRmk']),
                    WriterEntityFactory::createCell(null),
                ];
                ...
                if(($nKey+1)==FCNnHSizeOf($aDataReport['raItems'])){ //SumFooter
                    ...
                    $values= [
                        ...
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aDataSumFooterReport[0]['FCTxnValueSum']),$oStyle),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                    ];

...
class cRptCardNoActive extends MX_Controller {
    ...
    * Sys Bch Code
    ...
    private function init() {
        $this->aText = [
            'tTitleReport' => language('report/report/report', 'tRPCTitleRptCardNoActive'),
            ...
            // Table Report
            'tRPC6TBRowNuber' => language('report/report/report','tRPC6TBRowNuber'),
            'tRPC6TBCardCode' => language('report/report/report','tRPC6TBCardCode'),
            'tRPC6TBCardType' => language('report/report/report','tRPC6TBCardType'),
            'tRPC6TBCardName' => language('report/report/report','tRPC6TBCardName'),
            'tRPC6TBCardStartDate' => language('report/report/report','tRPC6TBCardStartDate'),
            'tRPC6TBCardExpireDate' => language('report/report/report','tRPC6TBCardExpireDate'),
            'tRPC6TBCardValue' => language('report/report/report','tRPC6TBCardValue'),
            'tRPC6TBCardStatus' => language('report/report/report','tRPC6TBCardStatus'),
            'tRPCStaActive1' => language('report/report/report','tRPCStaActive1'),
            'tRptConditionInReport' => language('report/report/report', 'tRptConditionInReport'),
            'tRPCStaActive2' => language('report/report/report','tRPCStaActive2'),
            'tRPCStaActive3' => language('report/report/report','tRPCStaActive3')
        ];
    ...
    public function index() {
        ...
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->mRptCardNoActive->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase = []) {
        ...
        // Get Data Report
        $aDataReport = $this->mRptCardNoActive->FSaMGetDataReport($aDataWhere, $this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrintClickPage() {
        ...
        $aDataReport = $this->mRptCardNoActive->FSaMGetDataReport($aDataWhere, $aDataFilter);
    ...
    public function FCNvCRenderKoolReportHtml($paDataReport, $paDataFilter) {
        ...
        require_once APPPATH . 'modules\report\datasources\reportcard\rptCardNoActive\rRptCardNoActive.php';

        // Set Parameter To Report
        $oRptKoolReportHtml = new rRptCardNoActive(array(
        ...
        $tHtmlViewReport = $oRptKoolReportHtml->render('wRptCardNoActiveHtml', true);
    ...
    public function  FSvCCallRptRenderExcel(){
        ...
        $aCells = [
            WriterEntityFactory::createCell($this->aText['tRPC6TBCardCode']),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell($this->aText['tRPC6TBCardType']),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell($this->aText['tRPC6TBCardName']),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell($this->aText['tRPC6TBCardStartDate']),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell($this->aText['tRPC6TBCardExpireDate']),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell($this->aText['tRPC6TBCardValue']),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell($this->aText['tRPC6TBCardStatus']),
            WriterEntityFactory::createCell(null),
        ...
        if(isset($aDataReport['raItems']) && !empty($aDataReport['raItems'])) {
            foreach ($aDataReport['raItems'] as $nKey => $aValue) {
                ...
                if($aValue['FTCrdStaActive'] == 1){
                    $tTextStaActive = $this->aText['tRPCStaActive1'];
                }else if($aValue['FTCrdStaActive'] == 2){
                    $tTextStaActive = $this->aText['tRPCStaActive2'];
                }else{
                    $tTextStaActive = $this->aText['tRPCStaActive3']; 
                }

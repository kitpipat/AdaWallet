...
class cRptCardTimesUsed extends MX_Controller {
    ...
    public function index() {
        ...
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->mRptCardTimesUsed->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase) {
        ...
        // Get Data Report
        $aDataReport = $this->mRptCardTimesUsed->FSaMGetDataReport($aDataWhere, $this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrintClickPage() {
        ...
        $aDataReport = $this->mRptCardTimesUsed->FSaMGetDataReport($aDataWhere, $aDataFilter);
    ...
    public function  FSvCCallRptRenderExcel(){
        ...
        $aCells = [
            WriterEntityFactory::createCell($this->aText['tRPC7TBTimesUsage']),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell($this->aText['tRPC7TBCardCode']),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell($this->aText['tRPC7TBCardType']),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell($this->aText['tRPC7TBCardName']),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell($this->aText['tRPC7TBCardHolderID']),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell($this->aText['tRPC7TBDepartName']),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell($this->aText['tRPC7TBRemark']),
            WriterEntityFactory::createCell(null),
        ...
        if(isset($aDataReport['raItems']) && !empty($aDataReport['raItems'])) {
            foreach ($aDataReport['raItems'] as $nKey => $aValue) {
                ...
                $values= [
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['TimesUsage'])),
                    WriterEntityFactory::createCell(null),
                    ...
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FTCrdRemark']),
                    WriterEntityFactory::createCell(null),
                ];

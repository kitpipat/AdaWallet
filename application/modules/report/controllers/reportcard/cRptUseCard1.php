        ...
        if(isset($aDataReport['raItems']) && !empty($aDataReport['raItems'])) {
            foreach ($aDataReport['raItems'] as $nKey => $aValue) {
                ...
                $values= [
                    ...
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell($aTxnDocNo[1]),
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell(($aTxnDocNoRef[1] == '') ? '-' : $aTxnDocNoRef[1]),
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell($aTxnDocTypeName[1]),
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell(($aTxnDocCreateBy[1] == '') ? '-' : $aTxnDocCreateBy[1]),
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell(date("d/m/Y", strtotime($aValue['rtTxnDocDate']))),
                    WriterEntityFactory::createCell(NULL),

...
class cRptClearCardValueForReuse extends MX_Controller {
    ...
    private function init() {
        $this->aText = [
            'tTitleReport' => language('report/report/report', 'tRPCTitleRptClearCardValueForReuse'),
            ...
            // Table Report
            'tRPC5TBRowNuber' => language('report/report/report','tRPC5TBRowNuber'),
            'tRPC5TBDocDate' => language('report/report/report','tRPC5TBDocDate'),
            'tRPC5TBCardCode' => language('report/report/report','tRPC5TBCardCode'),
            'tRPC5TBCardType' => language('report/report/report','tRPC5TBCardType'),
            'tRPC5TBCardName' => language('report/report/report','tRPC5TBCardName'),
            'tRptConditionInReport' => language('report/report/report', 'tRptConditionInReport'),
            'tRPC5TBCardTxnValue' => language('report/report/report','tRPC5TBCardTxnValue'),
    ...
    public function index() {
        ...
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->mRptClearCardValueForReuse->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase) {
        ...
        // Get Data Report
        $aDataReport = $this->mRptClearCardValueForReuse->FSaMGetDataReport($aDataWhere, $this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrintClickPage() {
        ...
        $aDataReport = $this->mRptClearCardValueForReuse->FSaMGetDataReport($aDataWhere, $aDataFilter);
    ...
    public function FCNvCRenderKoolReportHtml($paDataReport, $paDataFilter) {
        ...
        require_once APPPATH . 'modules\report\datasources\reportcard\rptClearCardValueForReuse\rRptClearCardValueForReuse.php';

        // Set Parameter To Report
        $oRptKoolReportHtml = new rRptClearCardValueForReuse(array(
        ...
        $tHtmlViewReport = $oRptKoolReportHtml->render('wRptClearCardValueForReuseHtml', true);
    ...
    public function FSoCChkDataReportInTableTemp($paDataSwitchCase) {
        ...
        try {
            ...
            $nDataCountPage = $this->mRptClearCardValueForReuse->FSaMCountDataReportAll($aDataCountData);
    ...
    function FSvCCallRptRenderExcel(){
        ...
        $aCells = [
            WriterEntityFactory::createCell(language('report/report/report', 'tRPC5TBRowNuber')),
            WriterEntityFactory::createCell(null),
            // WriterEntityFactory::createCell(language('report/report/report', 'tRPC5TBDocDate')),
            // WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRPC5TBCardCode')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRPC5TBCardType')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRPC5TBCardName')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRPC5TBCardTxnValue')),
        ...
        $aDataReport = $this->mRptClearCardValueForReuse->FSaMGetDataReport($aDataWhere);
            ...
            if (isset($aDataReport['raItems']) && !empty($aDataReport['raItems'])) {
                foreach ($aDataReport['raItems'] as $nKey => $aValue) {
                    $values = [
                        ...
                        WriterEntityFactory::createCell(null),
                        // WriterEntityFactory::createCell(date('Y-m-d',strtotime($aValue['FDTxnDocDate']))),
                        // WriterEntityFactory::createCell(null),
    ...
    function FSoCCallRptRenderFooterExcel(){
        ...
        if (!empty($this->aRptFilter['tCardCodeFrom']) && !empty($this->aRptFilter['tCardCodeTo'])) {
            $aCells = [
                WriterEntityFactory::createCell($this->aText['tRptCardCodeFrom'] . ' : ' . $this->aRptFilter['tCardCodeFrom'] . '     ' . $this->aText['tRptCardCodeTo'] . ' : ' . $this->aRptFilter['tCardCodeTo']),
                WriterEntityFactory::createCell(null),
                WriterEntityFactory::createCell(null),
                WriterEntityFactory::createCell(null),
                WriterEntityFactory::createCell(null),
        ...
        // ประเภทบัตร
        if (!empty($this->aRptFilter['tCardTypeCodeFrom']) && !empty($this->aRptFilter['tCardCodeTo'])) {
            $aCells = [
                WriterEntityFactory::createCell($this->aText['tRPCCrdTypeFrom'] . ' : ' . $this->aRptFilter['tCardTypeCodeFrom'] . '     ' . $this->aText['tRPCCrdTypeTo'] . ' : ' . $this->aRptFilter['tCardTypeCodeTo']),
                WriterEntityFactory::createCell(null),
                WriterEntityFactory::createCell(null),
                WriterEntityFactory::createCell(null),
                WriterEntityFactory::createCell(null),

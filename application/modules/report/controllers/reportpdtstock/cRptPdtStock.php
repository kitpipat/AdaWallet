...
class cRptPdtStock extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportpdtstock/mRptPdtStock');
    ...
    private function init()
    {
        $this->aText = [
            // Title
            'tTitleReport' => language('report/report/report', 'tRptTitleStockPdt'),
    ...
    public function index()
    {
        ...
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->mRptPdtStock->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase)
    {
        ...
        $aDataReport = $this->mRptPdtStock->FSaMGetDataReport($aDataWhereRpt);
    ...
    public function FSoCChkDataReportInTableTemp($paDataSwitchCase)
    {
        try {
            ...
            $nDataCountPage = $this->mRptPdtStock->FSnMCountDataReportAll($aDataCountData);
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                ...
                $values = [
                    ...
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(number_format($aValue['FCStkQtyMonEnd'], $this->nOptDecimalShow)),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(number_format($aValue['FCStkQtyIn'], $this->nOptDecimalShow)),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(number_format($aValue['FCStkQtyOut'], $this->nOptDecimalShow)),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(number_format($nStkQtySale, $this->nOptDecimalShow)),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(number_format($aValue['FCStkQtyAdj'], $this->nOptDecimalShow)),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(number_format($aValue['FCStkQtyBal'], $this->nOptDecimalShow)),
                    WriterEntityFactory::createCell(null),
                ];
                ...
                if (($nKey + 1) == count($aDataReport['aRptData'])) { //SumFooter
                    ...
                    $values = [
                        ...
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(number_format($nFCStkQtyMonEnd, $this->nOptDecimalShow)),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(number_format($nFCStkQtyIn, $this->nOptDecimalShow)),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(number_format($nFCStkQtyOut, $this->nOptDecimalShow)),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(number_format($nFCStkQtySale, $this->nOptDecimalShow)),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(number_format($nFCStkQtyAdj, $this->nOptDecimalShow)),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(number_format($nFCStkQtyBal, $this->nOptDecimalShow)),
                        WriterEntityFactory::createCell(null),
                    ];
    ...
    $tFTAddV1Village = $this->aCompanyInfo['FTAddV1Village']; 
        ...
        if (!empty($this->aRptFilter['tMonth']) && !empty($this->aRptFilter['tMonth'])) {
            $tMonth  = '';
            switch ($this->aRptFilter['tMonth']){
                case '01' :
                    $tMonth = language('report/report/report', 'tRptMonth01');
                break;
                case  '02' :
                    $tMonth = language('report/report/report', 'tRptMonth02');
                break;
                case  '03' :
                    $tMonth = language('report/report/report', 'tRptMonth03');
                break;
                case  '04' :
                    $tMonth = language('report/report/report', 'tRptMonth04');
                break;
                case  '05' :
                    $tMonth = language('report/report/report', 'tRptMonth05');
                break;
                case  '06' :
                    $tMonth = language('report/report/report', 'tRptMonth06');
                break;
                case  '07' :
                    $tMonth = language('report/report/report', 'tRptMonth07');
                break;
                case  '08' :
                    $tMonth = language('report/report/report', 'tRptMonth08');
                break;
                case  '09' :
                    $tMonth = language('report/report/report', 'tRptMonth09');
                break;
                case  '10' :
                    $tMonth = language('report/report/report', 'tRptMonth10');
                break;
                case  '11' :
                    $tMonth = language('report/report/report', 'tRptMonth11');
                break;
                case  '12' :
                    $tMonth = language('report/report/report', 'tRptMonth12');
                break;
            }

            $tRptFilterMonth = $this->aText['tRptMonth'] . '' .$tMonth;
            $aCells = [
                WriterEntityFactory::createCell(null),
                WriterEntityFactory::createCell(null),
                WriterEntityFactory::createCell(null),
                ...
                WriterEntityFactory::createCell(null),
                WriterEntityFactory::createCell(null),
                WriterEntityFactory::createCell($tRptFilterMonth),
                WriterEntityFactory::createCell(null),
                WriterEntityFactory::createCell(null),
                WriterEntityFactory::createCell(null),
                WriterEntityFactory::createCell(null),

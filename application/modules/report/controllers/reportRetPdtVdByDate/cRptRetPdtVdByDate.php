...
class cRptRetPdtVdByDate extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportRetPdtVdByDate/mRptRetPdtVdByDate');
    ...
    private function init()
    {
        $this->aText = [
            ...
            // TitleReport
            'tTitleReport' => language('report/report/report', 'tRptRetPdtVdTitle'),
            ...
            'tRptRetPdtVdDocNo' => language('report/report/report', 'tRptRetPdtVdDocNo'),
            'tRptRetPdtVdDocRefer' => language('report/report/report', 'tRptRetPdtVdDocRefer'),
            'tRptRetPdtVdDate' => language('report/report/report', 'tRptRetPdtVdDate'),
            'tRptRetPdtVdsequen' => language('report/report/report', 'tRptRetPdtVdsequen'),
            'tRptRetPdtVdCode' => language('report/report/report', 'tRptRetPdtVdCode'),
            'tRptRetPdtVdNamePdt' => language('report/report/report', 'tRptRetPdtVdNamePdt'),
            'tRptRetPdtVdAmount' => language('report/report/report', 'tRptRetPdtVdAmount'),
            'tRptRetPdtVdUnit' => language('report/report/report', 'tRptRetPdtVdUnit'),
            'tRptRetPdtVdRmkCancel' => language('report/report/report', 'tRptRetPdtVdRmkCancel'),
            'tRptRetPdtVdRmkReturn' => language('report/report/report', 'tRptRetPdtVdRmkReturn'),
            'tRptRetPdtVdCancel' => language('report/report/report', 'tRptRetPdtVdCancel'),
            'tRptRetPdtVdUsrReturn' => language('report/report/report', 'tRptRetPdtVdUsrReturn'),
            'tRptRetPdtVdApprov' => language('report/report/report', 'tRptRetPdtVdApprov'),
            'tRptRetPdtVdTotalReturnValue' => language('report/report/report', 'tRptRetPdtVdTotalReturnValue'),
            'tRptRetPdtVdTotal' => language('report/report/report', 'tRptRetPdtVdTotal'),
    ...
    public function index()
    {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->mRptRetPdtVdByDate->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint()
    {
        ...
        $aDataReport = $this->mRptRetPdtVdByDate->FSaMGetDataReport($aDataWhereRpt);
        ...
        $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/rptRetPdtVdByDate', 'wRptRetPdtVdByDateHtml', $aDataViewRpt);
    ...
    public function FSoCChkDataReportInTableTemp()
    {
        try {
            ...
            $nDataCountPage = $this->mRptRetPdtVdByDate->FSnMCountRowInTemp($aDataCountData);
            $aResponse = array(
    ...
    public function FSvCCallRptRenderExcel()
    {
        ...
        $oStyleBold = (new StyleBuilder())
            ...
            ->build();
        $aCells = [
            WriterEntityFactory::createCell(language('report/report/report', 'tRptRetPdtVdDocNo'),$oStyleBold),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptRetPdtVdDocRefer'),$oStyleBold),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptRetPdtVdCode'),$oStyleBold),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptRetPdtVdNamePdt'),$oStyleBold),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptRetPdtVdDate'),$oStyleBold),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptRetPdtVdAmount'),$oStyleBold),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptRetPdtVdUnit'),$oStyleBold),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptRndVal'),$oStyleBold),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptProductValue'),$oStyleBold),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptRetPdtVdRmkReturn'),$oStyleBold),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptRetPdtVdUsrReturn'),$oStyleBold),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptRetPdtVdApprov'),$oStyleBold),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell("Type 1:HD, 2:DT",$oStyleBold),
            WriterEntityFactory::createCell(null),
        ];
        ...
        $aDataReport = $this->mRptRetPdtVdByDate->FSaMGetDataReport($aDataReportParams);
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                $values = [
                    ...
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FTXihRefIn']),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(null),
                    ...
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FDXihDocDate']),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCXidQty"], 0)),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FTPunName']),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCXshRnd'])),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCXtdAmount'])),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FTRsnName']),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FTUsrName']),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FTXshApvName']),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FTXthTnsType']),
                    WriterEntityFactory::createCell(null),
                ...
                if (($nKey + 1) == FCNnHSizeOf($aDataReport['aRptData'])) { //SumFooter
                    $values = [
                        WriterEntityFactory::createCell($this->aText['tRptRetPdtVdTotalReturnValue'],$oStyleBold),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        ...
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCXshRnd_Footer']),$oStyleBold),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCXtdAmount_Footer']),$oStyleBold),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),

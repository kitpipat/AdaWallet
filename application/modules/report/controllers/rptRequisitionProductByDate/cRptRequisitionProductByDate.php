...
class cRptRequisitionProductByDate extends MX_Controller
{
    ...
    public function __construct(){
        ...
        $this->load->model('report/rptRequisitionProductByDate/mRptRequisitionProductByDate');
    ...
    private function init(){
        $this->aText = [
            'tTitleReport'          => language('report/report/report', 'tRptTitleReqPDTByDate'),
            ...
            'tRptBchFrom'           => language('report/report/report', 'tRptBchFrom'),
            'tRptBchTo'             => language('report/report/report', 'tRptBchTo'),
            'tRptRef'               => language('report/report/report', 'tRptSaleShopGroupVDDocRef'),
    ...
    public function index(){
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            $this->mRptRequisitionProductByDate->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase){
        ...
        $aDataReport = $this->mRptRequisitionProductByDate->FSaMGetDataReport($aDataWhereRpt);
        ...
        $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/rptRequisitionProductByDate', 'wRptRequisitionProductByDate', $aDataViewPdt);
    ...
    public function FSvCCallRptViewBeforePrintClickPage(){
        ...
        // Load View Advance Table
        $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/rptTransferVendingOut', 'wRptTransferVendingOutHtml', $aDataViewPdt);
    ...
    /**
     * Functionality    : Render Excel Report Header [Header]
     * Parameters       : Function Parameter
     * Creator          : 29/12/2020 Supawat
     * LastUpdate       :
     * Return           : oject
    ...
    $tFTAddV1Village = $this->aCompanyInfo['FTAddV1Village']; 
     ...
     /**
     * Functionality    : Render Excel Report [Content]
     * Parameters       : Function Parameter
     * Creator          : 29/12/2020 Supawat
     * LastUpdate       :
     * Return           : file
    ...
    public function FSvCCallRptRenderExcel(){
        ...
        $aCells = [
            ...
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptTakeoutPdtBchName')),
            WriterEntityFactory::createCell(null),
            ...
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptSaleShopGroupVDDocRef')),
            WriterEntityFactory::createCell(null),
            ...
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptReqPDTWah')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptTo')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tQty')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptListener')),
            WriterEntityFactory::createCell(null),
        ];
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                ...
                $values = [
                    ...
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(date("Y-m-d", strtotime($aValue["FDXthDocDate"]))),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(($aValue["FTXthRefDoc"] == '') ? '-' : $aValue["FTXthRefDoc"]),
                    WriterEntityFactory::createCell(null),
                    ...
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FTXtdWahFrm']),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FTXthOther']),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(null),
    ...
    /**
     * Functionality    : Render Excel Report Footer [Footer]
     * Parameters       :  Function Parameter
     * Creator          : 29/12/2020 Supawat
     * LastUpdate       :
     * Return           : oject

...
class cReorderPointPerPdt extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportReorderPointPerPdt/mReorderPointPerPdt');
    ...
    private function init()
    {
        ...
        $this->aText = [
            'tTitleReport'  => language('report/report/report', 'tRptPdtPointProductTitle'),
            ...
            'tRptPointPurchase'   => language('report/report/report', 'tRptPointPurchase'), // จุดสั่งซื้อ
            'tRptRetailWah'       => language('report/report/report', 'tRptRetailWah'), // คลังปลีก
            'tRptDeliverywah'     => language('report/report/report', 'tRptDeliverywah'), // คลังส่ง
            'tRptShdOrder'        => language('report/report/report', 'tRptShdOrder'),  //ควรสั่งซื้อ
    ...
    public function index()
    {
        if (!empty($this->tRptCode) && !empty($this->tRptExportType)) {
            ...
            $this->mReorderPointPerPdt->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function  FSvCCallRptViewBeforePrint()
    {
        ...
        try {
            ...
            $aDataReport = $this->mReorderPointPerPdt->FSaMGetDataReport($aDataReportParams);
            ...
            $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportReorderPointPerPdt', 'wRptReorderPointPerPdtHtml', $aDataViewRptParams);
    ...
    public function FSvCCallRptExportFile()
    {
        ...
        $aCells = [
            ...
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell('จำนวนคลัง'),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptPointPurchase')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell('จำนวนแนะนำ'),
            WriterEntityFactory::createCell(null),
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                ...
                $values = [
                    ...
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCSpwQtyMin'])),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCQtySuggest'])),
                    WriterEntityFactory::createCell(null),
                ];
                ...
                if (($nKey + 1) == FCNnHSizeOf($aDataReport['aRptData'])) {
                    $values = [
                        ...
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCSpwQtyMin_Footer'])),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCQtySuggest_Footer'])),
                        WriterEntityFactory::createCell(null),
                    ];
    ...
    public function FSoCCallRptRenderFooterExcel()
    {
        ...
        // กลุ่มร้านค้า แบบเลือก
        if (!empty($this->aRptFilter['tShpCodeSelect'])) {
            $tShpSelect = ($this->aRptFilter['bShpStaSelectAll']) ? $this->aText['tRptAll'] : $this->aRptFilter['tShpCodeSelect'];
            $aCells = [
        ...
        // Fillterฺ Mar (กลุ่มสินค้า) แบบช่วง

...
class cRptDayEndSales extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportsale/mRptDayEndSales');
    ...
    private function init()
    {
        $this->aText = [
            ...
            'tRptEndDaySaleTitle'   => language('report/report/report', 'tRptEndDaySaleTitle'),
    ...
    public function index()
    {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->mRptDayEndSales->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paData)
    {
        ...
        // Get Data Report
        $aDataReport = $this->mRptDayEndSales->FSaMGetDataReport($aDataWhere);
        ...
        $tRptView     = JCNoHLoadViewAdvanceTable('report/datasources/rptDayEndSales', 'wRptDayEndSalesHtml.view', $aDataViewRptParams);
    ...
    public function FSvCCallRptViewBeforePrintClickPage()
    {
        ...
        $tRptView     = JCNoHLoadViewAdvanceTable('report/datasources/rptDayEndSales', 'wRptDayEndSalesHtml.view', $aDataViewRpt);
    ...
    public function FSoCChkDataReportInTableTemp($paDataSwitchCase)
    {
        try {
            ...
            $nDataCountPage = $this->mRptDayEndSales->FSnMCountDataReportAll($aDataCountData);
    ...
    public function FSvCCallRptRenderExcel()
    {
        ...
        // Get Data Report
        $aDataReport = $this->mRptDayEndSales->FSaMGetDataReport($aDataReportParams);

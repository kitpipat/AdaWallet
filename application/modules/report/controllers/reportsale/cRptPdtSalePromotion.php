...
class cRptPdtSalePromotion extends MX_Controller {
          /**
     * ภาษา
     * @var array
     */
    ...
    public function __construct() {
        ...
        $this->load->model('report/reportsale/mRptPdtSalePromotion');
    ...
    private function init(){
        $this->aText = [
            'tTitleReport'          => language('report/report/report', 'tRptSaleProduct'),
    ...
    public function index(){
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->mRptPdtSalePromotion->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint(){
        try{
            ...
            $aDataReport = $this->mRptPdtSalePromotion->FSaMGetDataReport($aDataWhere);
            ...
            // Load View Advance Table
            $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportsale/rptPdtSalePromotion', 'wRptPdtSalePromotionHtml', $aDataViewRptParams);
    ...
    public function FSvCCallRptViewBeforePrintClickPage(){
        ...
        $aDataReport = $this->mRptPdtSalePromotion->FSaMGetDataReport($aDataWhereRpt);
     ...
     * Parameters:  Function Parameter
     * Creator: 20/01/2021 Witsarut(Bell)
     * LastUpdate:
     * Return: file
     * ReturnType: file
     */
    public function FSvCCallRptRenderExcel(){
        ...
        $aCells = [
            WriterEntityFactory::createCell($this->aText['tRptPromotion']),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell($this->aText['tRpePmoBarCode']),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell($this->aText['tRptPmoProduct']),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell($this->aText['tRptPmoSup']),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell($this->aText['tRptPmoModelPro']),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell($this->aText['tRptPmoScored']),
            WriterEntityFactory::createCell(NULL),
        ...
        $aDataReport = $this->mRptPdtSalePromotion->FSaMGetDataReport($aDataReportParams);
        ...
        if(isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])){
            foreach($aDataReport['aRptData'] as $nKey => $aValue){
                ...
                $values = [
                    ...
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell($tGetTypePmh),
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCXpdPoint'])),
                    WriterEntityFactory::createCell(NULL),

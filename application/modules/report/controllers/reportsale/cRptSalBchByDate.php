...
class cRptSalBchByDate extends MX_Controller
{
    ...
    {
        $this->load->model('report/reportsale/mRptSalBchByDate');
    ...
    private function init()
    {
        $this->aText = [
            // Title
            'tTitleReport' => language('report/report/report', 'tRptSalBchByDate'),
    ...
    public function index()
    {
        ...
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->mRptSalBchByDate->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase)
    {
        ...
        $aDataReport = $this->mRptSalBchByDate->FSaMGetDataReport($aDataWhereRpt);
        ...
        $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportsale/rptSalBchByDate', 'wRptSalBchByDateHtml', $aDataViewRptParams);
    ...
    public function FSvCCallRptViewBeforePrintClickPage()
    {
        ...
        $aDataReport = $this->mRptSalBchByDate->FSaMGetDataReport($aDataWhere, $aDataFilter);
        // print_r($aDataReport);
        // exit;
        ...
        $tViewRenderKool = JCNoHLoadViewAdvanceTable('report/datasources/reportsale/rptSalBchByDate', 'wRptSalBchByDateHtml', $aDataViewRptParams);

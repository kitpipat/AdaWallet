...
class cRptPdtSalePromotionPerDoc extends MX_Controller {
    /**
     * ภาษา
     * @var array
     */
    ...
    public function __construct() {
        ...
        $this->load->model('report/reportsale/mRptPdtSalePromotionPerDoc');
    ...
    private function init(){
        $this->aText = [
            'tTitleReport'          => language('report/report/report', 'tRptSaleProductPerDoc'),
    ...
    public function index(){
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->mRptPdtSalePromotionPerDoc->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint(){
        try{
            ...
            $aDataReport    = $this->mRptPdtSalePromotionPerDoc->FSaMGetDataReport($aDataWhere);
          ...
          // Load View Advance Table
          $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportsale/rptPdtSalePromotionPerDoc', 'wRptPdtSalePromotionPerDocHtml', $aDataViewRptParams);
    ...
    public function FSvCCallRptViewBeforePrintClickPage(){
        ...
        $aDataReport    = $this->mRptPdtSalePromotionPerDoc->FSaMGetDataReport($aDataWhereRpt);
    ...
    public function FSvCCallRptRenderExcel(){
        ...
        $aDataReport    = $this->mRptPdtSalePromotionPerDoc->FSaMGetDataReport($aDataReportParams);

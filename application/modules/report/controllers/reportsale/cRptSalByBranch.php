...
class cRptSalByBranch extends MX_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('report/reportsale/mRptSalByBranch');
    ...
    private function init() {
        $this->aText = [
            ...
            // TitleReport
            'tTitleReport'      => language('report/report/report', 'tRptSalByBranchTitle'),
            ...
            'tRptAddrTaxNo'               => language('report/report/report', 'tRptAddrTaxNo'),
             ...
             'tRptTotalFooter'      => language('report/report/report', 'tRptTotalFooter'),
             'tRptSalByBranchSeq'     => language('report/report/report', 'tRptSalByBranchSeq'),
             ...
             'tRptSalByBranchQtyBill'        => language('report/report/report', 'tRptSalByBranchQtyBill'),
             'tRptSalByBranchGrand'     => language('report/report/report', 'tRptSalByBranchGrand'),
    ...
    public function index() {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->mRptSalByBranch->FSnMExecStoreReport($this->aRptFilter);
    ...
    */
    public function FSvCCallRptViewBeforePrint() {
        ...
        $aDataReport = $this->mRptSalByBranch->FSaMGetDataReport($aDataWhereRpt);
        ...
        $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportsale/rptSalByBranch', 'wRptSalByBranchHtml', $aDataViewRpt);
    ...
    */
    public function FSoCChkDataReportInTableTemp() {
        try {
            ...
            $nDataCountPage = $this->mRptSalByBranch->FSnMCountRowInTemp($aDataCountData);
            $aResponse = array(
    ...
    //  ===========================================================================================
        ...
        $aCells = [
            WriterEntityFactory::createCell(language('report/report/report','tRptSalByBranchSeq')),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell(language('report/report/report','tRptSalByBranchBchCode')),
            WriterEntityFactory::createCell(NULL),
            ...
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell(language('report/report/report','tRptSalByBranchQtyBill')),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell(language('report/report/report','tRptSalByBranchGrand')),
        ];
  ...
  //Get Data
  $aDataReport = $this->mRptSalByBranch->FSaMGetDataReport($aDataReportParams);
     ...
     if(isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
         foreach ($aDataReport['aRptData'] as $nKey => $aValue) { 
                   $values= [
                            ...
                            WriterEntityFactory::createCell(NULL),
                            WriterEntityFactory::createCell(NULL),
                            WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FNSalBillQty"])),
                            WriterEntityFactory::createCell(NULL),
                            WriterEntityFactory::createCell(NULL),
                ...
                if(($nKey+1)==FCNnHSizeOf($aDataReport['aRptData'])){ //SumFooter
                    $values= [
                        ...
                        WriterEntityFactory::createCell(NULL),
                        WriterEntityFactory::createCell(NULL),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCXrnQty_Footer"])),
                        WriterEntityFactory::createCell(NULL),
                        WriterEntityFactory::createCell(NULL),

...
class cRptMnyShotOver extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportsale/mRptMnyShotOver');
    ...
    private function init()
    {
        $this->aText = [
            ...
            // TitleReport
            'tTitleReport' => language('report/report/report', 'tRptMnyTitle'),
            ...
            //cr Rrport
            'tRptMnyTitle' => language('report/report/report', 'tRptMnyTitle'),
            'tRptMnyPos' => language('report/report/report', 'tRptMnyPos'),
            'tRptMnyUsrId' => language('report/report/report', 'tRptMnyUsrId'),
            'tRptMnyAmt' => language('report/report/report', 'tRptMnyAmt'),
            'tRptMnyMM' => language('report/report/report', 'tRptMnyMM'),
            'tRptMnyOM' => language('report/report/report', 'tRptMnyOM'),
            'tRptMnyCashIn' => language('report/report/report', 'tRptMnyCashIn'),
            'tRptMnyCashOut' => language('report/report/report', 'tRptMnyCashOut'),
            'tRptMnySign' => language('report/report/report', 'tRptMnySign'),
            'tRptMnySignMas' => language('report/report/report', 'tRptMnySignMas'),
    ...
    public function index()
    {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->mRptMnyShotOver->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint()
    {
        ...
        //  print_r($aDataWhereRpt); die();
        $aDataReport = $this->mRptMnyShotOver->FSaMGetDataReport($aDataWhereRpt);
        ...
        $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportsale/rptMnyShotOver', 'wRptMnyShotOverHtml', $aDataViewRpt);
    ...
    public function FSoCChkDataReportInTableTemp()
    {
        try {
            ...
            $nDataCountPage = $this->mRptMnyShotOver->FSnMCountRowInTemp($aDataCountData);
            $aResponse = array(
    ...
    public function FSvCCallRptRenderExcel()
    {
        ...
        $aCells = [
            ...
            WriterEntityFactory::createCell(language('report/report/report', 'tRptMnyPos')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptMnyUsrId')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptDate')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptMnyMM')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptMnyOM')),
            WriterEntityFactory::createCell(null),
            ...
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptMnySign')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptMnySignMas')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
        ];
        ...
        $aDataReport = $this->mRptMnyShotOver->FSaMGetDataReport($aDataReportParams);

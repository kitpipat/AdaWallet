...
date_default_timezone_set("Asia/Bangkok");
class cRptMnyShotOverDaily extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportsale/mRptMnyShotOverDaily');
    ...
    private function init()
    {
        $this->aText = [
            ...
            // TitleReport
            'tTitleReport' => language('report/report/report', 'tRptMnyDairyTitle'),
            ...
            'tRptMnyDairyPos' => language('report/report/report', 'tRptMnyDairyPos'),
            'tRptMnyDairyUsrId' => language('report/report/report', 'tRptMnyDairyUsrId'),
            'tRptMnyDairyAmt' => language('report/report/report', 'tRptMnyDairyAmt'),
            'tRptMnyDairyMM' => language('report/report/report', 'tRptMnyDairyMM'),
            'tRptMnyDairyOM' => language('report/report/report', 'tRptMnyDairyOM'),
            'tRptMnyDairyCash' => language('report/report/report', 'tRptMnyDairyCash'),
            'tRptMnyDairyCredit' => language('report/report/report', 'tRptMnyDairyCredit'),
            'tRptMnyDairyVouchers' => language('report/report/report', 'tRptMnyDairyVouchers'),
            'tRptMnyDairyCoupon' => language('report/report/report', 'tRptMnyDairyCoupon'),
            'tRptMnyDairyCheck' => language('report/report/report', 'tRptMnyDairyCheck'),
            'tRptMnyDairyOther' => language('report/report/report', 'tRptMnyDairyOther'),
            'tRptMnyDairySales' => language('report/report/report', 'tRptMnyDairySales'),
            'tRptMnyDairyCloseshift' => language('report/report/report', 'tRptMnyDairyCloseshift'),
            'tRptMnyDairyFromSystem' => language('report/report/report', 'tRptMnyDairyFromSystem'),
            'tRptMnyDairyPromptPay' => language('report/report/report', 'tRptMnyDairyPromptPay'),
    ...
    public function index()
    {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->mRptMnyShotOverDaily->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint()
    {
        ...
        $aDataReport = $this->mRptMnyShotOverDaily->FSaMGetDataReport($aDataWhereRpt);
        ...
        $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportsale/rptMnyShowOverDaily', 'wRptMnyShowOverDailyHtml', $aDataViewRpt);
    ...
    public function FSoCChkDataReportInTableTemp()
    {
        try {
            ...
            $nDataCountPage = $this->mRptMnyShotOverDaily->FSnMCountRowInTemp($aDataCountData);
            $aResponse = array(
    ...
    public function FSvCCallRptRenderExcel()
    {
        ...
        $aCells = [
            ...
            WriterEntityFactory::createCell(language('report/report/report', 'tRptMnyDairyPos')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptMnyDairyUsrId')),
            WriterEntityFactory::createCell(null),
            ...
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptMnyDairyAmt')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            ...
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptMnyDairyCash')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null, $oStyleColumsRight),

            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptMnyDairyCredit')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null, $oStyleColumsRight),

            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptMnyDairyVouchers')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null, $oStyleColumsRight),

            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptMnyDairyCoupon')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null, $oStyleColumsRight),

            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptMnyDairyCheck')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null, $oStyleColumsRight),

            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptMnyDairyPromptPay')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null, $oStyleColumsRight),

            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptMnyDairyOther')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null, $oStyleColumsRight),

            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptMnyDairySales')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null, $oStyleColumsRight),
        ...
        $aCells = [
            ...
            WriterEntityFactory::createCell(null, $oStyleColumsLeft),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptMnyCashIn'), $oStyleColumsRight),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptMnyCashOut'), $oStyleColumsRight),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptMnyMM'), $oStyleColumsRight),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptMnyOM'), $oStyleColumsRight),

            
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptMnyDairyCloseshift'),$oStyleColumsRight),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptMnyDairyFromSystem'),$oStyleColumsRight),
        ...
        $aDataReport = $this->mRptMnyShotOverDaily->FSaMGetDataReport($aDataReportParams);
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                $values = [
                    ...
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(date('d/m/Y', strtotime($aValue['FDShdSaleDate']))),
                    WriterEntityFactory::createCell(null),
                    ...
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCMnyShot"] * (-1))),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCMnyOver"])),
                    
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCKbnAmtCash"])),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCRcvPayCash"])),
                    
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCKbnAmtCredit"])),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCRcvPayCredit"])),
                    
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCKbnAmtVouchers"])),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCRcvPayVouchers"])),
                    
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCKbnAmtCoupon"])),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCRcvPayCoupon"])),
                    
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCKbnAmtChque"])),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCRcvPayChque"])),
                    
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCKbnAmtPromptpay"])),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCRcvPayPromptpay"])),
                    
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCKbnAmtOther"])),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCRcvPayOther"])),
                    
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCAmtShipClose"])),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCAmtSystem"])),
                ];
                ...
                if (($nKey + 1) == FCNnHSizeOf($aDataReport['aRptData'])) { //SumFooter
                    $values = [
                        ...
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCMnyShot_Footer"] * (-1))),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCMnyOver_Footer"])),
                        
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCKbnAmtCash_Footer"])),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCRcvPayCash_Footer"])),
                        
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCKbnAmtCredit_Footer"])),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCRcvPayCredit_Footer"])),
                        
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCKbnAmtVouchers_Footer"])),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCRcvPayVouchers_Footer"])),
                        
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCKbnAmtCoupon_Footer"])),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCRcvPayCoupon_Footer"])),
                        
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCKbnAmtChque_Footer"])),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCRcvPayChque_Footer"])),
                        
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCKbnAmtPromptpay_Footer"])),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCRcvPayPromptpay_Footer"])),
                        
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCKbnAmtOther_Footer"])),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCRcvPayOther_Footer"])),
                        
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCAmtShipClose_Footer"])),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCAmtSystem_Footer"])),
                    ];
    ...
    public function FSoCCallRptRenderFooterExcel()
    {
        ...
        // Fillterฺ Cashier (แคชเชียร์)) แบบช่วง

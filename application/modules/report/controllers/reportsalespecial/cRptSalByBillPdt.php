...
class cRptSalByBillPdt extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportsalespecial/mRptSalByBillPdt');
    ...
    private function init()
    {
        $this->aText = [
            // Title
            'tTitleReport' => language('report/report/report', 'rptSalByBillPdtTitle'),
            ...
            'tRptQty2' => language('report/report/report', 'tRptQty2'),
            'tRptPricePerUnit' => language('report/report/report', 'tRptPricePerUnit'),
            'tRptTotalAmount' => language('report/report/report', 'tRptTotalAmount'),
    ...
    public function index()
    {
        ...
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->mRptSalByBillPdt->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase)
    {
        ...
        $aDataReport = $this->mRptSalByBillPdt->FSaMGetDataReport($aDataWhereRpt);
        ...
        $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportsalespecial/reportSalByBillPdt', 'wRptSalByBillPdtHtml', $aDataViewRptParams);
    ...
    public function FSvCCallRptViewBeforePrintClickPage()
    {
        ...
        $aDataReport = $this->mRptSalByBillPdt->FSaMGetDataReport($aDataWhere, $aDataFilter);
        // print_r($aDataReport);
        // exit;
        ...
        $tViewRenderKool = JCNoHLoadViewAdvanceTable('report/datasources/reportsalespecial/reportSalByBillPdt', 'wRptSalByBillPdtHtml', $aDataViewRptParams);
    ...
    public function FSvCCallRptRenderExcel()
    {
        ...
        $aCells = [
            ...
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptProduct')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            ...
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptQty2')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptPricePerUnit')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tDiscount')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptTotalAmount')),
        ];
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                ...
                if (($nKey + 1) == FCNnHSizeOf($aDataReport['aRptData'])) { //SumFooter
                    $values = [
                        WriterEntityFactory::createCell(language('report/report/report', 'tRptTotalFooter')),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),

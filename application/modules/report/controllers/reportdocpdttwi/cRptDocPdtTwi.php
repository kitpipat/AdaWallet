...
class cRptDocPdtTwi extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportdocpdttwi/mRptDocPdtTwi');
    ...
    private function init()
    {
        $this->aText = [
            ...
            // TitleReport
            'tTitleReport' => language('report/report/report', 'tRptDocPdtTwiTitle'),
            ...
            'tRptDocPdtTwiDocNo' => language('report/report/report', 'tRptDocPdtTwiDocNo'),
            'tRptDocPdtTwiDocDate' => language('report/report/report', 'tRptDocPdtTwiDocDate'),
            'tRptDocPdtTwiPdtSrc' => language('report/report/report', 'tRptDocPdtTwiPdtSrc'),
            'tRptDocPdtTwiRefSrc' => language('report/report/report', 'tRptDocPdtTwiRefSrc'),
            'tRptDocPdtTwiWahTo' => language('report/report/report', 'tRptDocPdtTwiWahTo'),
            'tRptDocPdtTwiApvName' => language('report/report/report', 'tRptDocPdtTwiApvName'),
            'tRptDocPdtTwiSeq' => language('report/report/report', 'tRptDocPdtTwiSeq'),
            'tRptDocPdtTwiPdtCode' => language('report/report/report', 'tRptDocPdtTwiPdtCode'),
            'tRptDocPdtTwiPdtName' => language('report/report/report', 'tRptDocPdtTwiPdtName'),
            'tRptDocPdtTwiQty' => language('report/report/report', 'tRptDocPdtTwiQty'),
            'tRptDocPdtTwiPunName' => language('report/report/report', 'tRptDocPdtTwiPunName'),
    ...
    public function index()
    {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->mRptDocPdtTwi->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint()
    {
        ...
        $aDataReport = $this->mRptDocPdtTwi->FSaMGetDataReport($aDataWhereRpt);
        // print_r($aDataReport);
        // die();
        ...
        $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/rptDocPdtTwi', 'wRptDocPdtTwiHtml', $aDataViewRpt);
    ...
    public function FSoCChkDataReportInTableTemp()
    {
        try {
            ...
            $nDataCountPage = $this->mRptDocPdtTwi->FSnMCountRowInTemp($aDataCountData);
            $aResponse = array(
    ...
    public function FSvCCallRptRenderExcel()
    {
        ...
        $aCells = [
            WriterEntityFactory::createCell(language('report/report/report', 'tRptDocPdtTwiDocNo')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptDocPdtTwiDocDate')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptDocPdtTwiPdtSrc')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptDocPdtTwiRefSrc')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptDocPdtTwiWahTo')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptDocPdtTwiApvName')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptDocPdtTwiSeq')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptDocPdtTwiPdtCode')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptDocPdtTwiPdtName')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptDocPdtTwiQty')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptDocPdtTwiPunName')),
            WriterEntityFactory::createCell(null),
        ];
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                $values = [
                    ...
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(language('report/report/report', 'tRptDocPdtTwiSrcType'.$aValue["FTXthPdtSrc"])),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FTXthRefSrc']),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FTWahName']),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FTUsrName']),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FNXtdSeqNo']),
                    WriterEntityFactory::createCell(null),

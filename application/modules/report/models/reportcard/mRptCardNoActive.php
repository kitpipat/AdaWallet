...
class mRptCardNoActive extends CI_Model {
    ...
    public function FSnMExecStoreReport($paDataFilter = []) {
        ...
        $aDataStore = array(
            ...
            // วันที่เริ่มต้น
            'ptStartDateF' => $paDataFilter['tDateStartFrom'],
            'ptStartDateT' => $paDataFilter['tDateStartTo'],
            // วันที่หมดอายุ
            'ptExpDateF' => $paDataFilter['tDateExpireFrom'],
            'ptExpDateT' => $paDataFilter['tDateExpireTo'],
            // หมายเลขบัตร

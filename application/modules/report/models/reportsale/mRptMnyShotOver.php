...
class mRptMnyShotOver extends CI_Model {
    ...
    public function FSaMGetDataReport($paDataWhere) {
        ...
        $tSQL = "   
            ...
            FROM (
                SELECT  
                    ROW_NUMBER() OVER(ORDER BY FTBchCode ASC , FTPosCode ASC , FDShdSaleDate ASC) AS RowID,
                    A.*,
                    S.FNRptGroupMember
        ...
        $tSQL .= " ORDER BY FTBchCode ASC , FTPosCode ASC , FDShdSaleDate ASC ";

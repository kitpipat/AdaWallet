                            ...
                            foreach($aDataReport['aRptData'] as $aData){
                                ...
                                <tr style="<?=$tStyleUnderLine;?>">
                                    <?php if($aData['FTTnsType'] == '1'){ ?>
                                        ...
                                        <td class="text-left xCNRptDetail" colspan="2"><?php echo "(".$aData['FTUsrCode'].") " . $tName;?></td>
                                    <?php }else{ ?>
                                        <td class="text-left xCNRptDetail"></td>
                                        <td class="text-left xCNRptDetail"><?php echo $aData['FTRcvName']; ?></td>
                                    <?php } ?>
                                    <td class="text-right xCNRptDetail"><?php echo number_format($aData['FCXshNet'],$nOptDecimalShow); ?></td>
                                    <td class="text-right xCNRptDetail"><?php echo number_format($aData['FCXshReturn'],$nOptDecimalShow); ?></td>
                                    <td class="text-right xCNRptDetail"><?php echo number_format($aData['FCXshRnd'],$nOptDecimalShow); ?></td>

        ...
        <div class="xCNContentReport">
            <div id="odvRptTableRPD" class="table-responsive">
                <table class="table" >
                    <thead>
                        <tr>
                            <th class="text-left xCNRptColumnHeader" width="12%" ><?php echo $aDataTextRef['tRptDocPdtTwiDocNo']; ?></th>
                            <th class="text-left xCNRptColumnHeader" width="12%" ><?php echo $aDataTextRef['tRptDocPdtTwiDocDate']; ?></th>
                            <th class="text-left xCNRptColumnHeader" width="12%" ><?php echo $aDataTextRef['tRptDocPdtTwiPdtSrc']; ?></th>
                            <th class="text-left xCNRptColumnHeader" width="24%" ><?php echo $aDataTextRef['tRptDocPdtTwiRefSrc']; ?></th>
                            <th class="text-left xCNRptColumnHeader" width="25%" ><?php echo $aDataTextRef['tRptDocPdtTwiWahTo']; ?></th>
                            <th class="text-left xCNRptColumnHeader" colspan="2" width="15%"><?php echo $aDataTextRef['tRptDocPdtTwiApvName']; ?></th>
                        </tr>
                        <tr>
                            <th class="text-center xCNRptColumnHeader" with=""><?php echo $aDataTextRef['tRptDocPdtTwiSeq']; ?></th>
                            <th class="text-left xCNRptColumnHeader" ><?php echo $aDataTextRef['tRptDocPdtTwiPdtCode']; ?></th>
                            <th class="text-left xCNRptColumnHeader" colspan="3" ><?php echo $aDataTextRef['tRptDocPdtTwiPdtName']; ?></th>
                            <th class="text-center xCNRptColumnHeader" ><?php echo $aDataTextRef['tRptDocPdtTwiQty']; ?></th>
                            <th class="text-left xCNRptColumnHeader" ><?php echo $aDataTextRef['tRptDocPdtTwiPunName']; ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php if(!empty($aDataReport['aRptData'])){
                            ...
                            <?php foreach($aDataReport['aRptData'] as $aData){
                                    if($tXthDocNo!=$aData['FTXthDocNo']){
                                ?>

                                    <tr style="border-top: 1px solid black !important;">
                                        <td class="text-left xCNRptDetail"><?php echo $aData['FTXthDocNo']; ?></td>
                                        <td class="text-left xCNRptDetail"><?php echo date("d/m/Y",strtotime($aData['FDXthDocDate']));  ?></td>
                                        <td class="text-left xCNRptDetail"><?php echo $aDataTextRef['tRptDocPdtTwiSrcType'.$aData["FTXthPdtSrc"]] ?></td>
                                        <td class="text-left xCNRptDetail"><?php echo $aData['FTXthRefSrc']?></td>
                                        <td class="text-left xCNRptDetail"><?php echo $aData['FTWahName']?></td>
                                        <td class="text-left xCNRptDetail" colspan="2" ><?php echo $aData['FTUsrName']; ?></td>
                                    </tr>
                                    <?php } ?>
                                    <tr>
                                        <td class="text-center xCNRptDetail "><?php echo $aData['FNXtdSeqNo']; ?></td>
                                        <td class="text-left xCNRptDetail"><?php echo $aData["FTPdtCode"]?></td>
                                        <td class="text-left xCNRptDetail" colspan="3" ><?php echo $aData['FTPdtName']?></td>
                                        <td class="text-right xCNRptDetail"><?php echo number_format($aData['FCXtdQty'],$nOptDecimalShow)?></td>
                                        <td class="text-left xCNRptDetail" ><?php echo $aData['FTPunName']; ?></td>
                                    </tr>

                            <?php

                                  $tXthDocNo = $aData['FTXthDocNo'];

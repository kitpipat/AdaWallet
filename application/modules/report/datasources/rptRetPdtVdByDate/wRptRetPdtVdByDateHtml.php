        ...
        <div class="xCNContentReport">
            <div id="odvRptTableRPD" class="table-responsive">
                <table class="table" >
                    <thead>
                        <tr>
                            <th class="text-left xCNRptColumnHeader" width="15%"><?php echo $aDataTextRef['tRptRetPdtVdDocNo']; ?></th>
                            <th class="text-left xCNRptColumnHeader" width="15%" ><?php echo $aDataTextRef['tRptRetPdtVdDate']; ?></th>
                            <th class="text-left xCNRptColumnHeader" width="20%"><?php echo $aDataTextRef['tRptRetPdtVdDocRefer']; ?></th>
                            <th class="text-left xCNRptColumnHeader"  colspan="2" style="vertical-align: middle;"><?php echo $aDataTextRef['tRptRetPdtVdRmkReturn']; ?></th>
                            <th class="text-left xCNRptColumnHeader" colspan="2"  style="vertical-align: middle;"><?php echo $aDataTextRef['tRptRetPdtVdUsrReturn']; ?></th>
                            <th class="text-left xCNRptColumnHeader"></th>

                        </tr>
                        <tr>
                            <th class="text-center xCNRptColumnHeader"><?php echo $aDataTextRef['tRptRetPdtVdsequen']; ?></th>
                            <th class="text-left xCNRptColumnHeader"><?php echo $aDataTextRef['tRptRetPdtVdCode']; ?></th>
                            <th class="text-left xCNRptColumnHeader" colspan="4"><?php echo $aDataTextRef['tRptRetPdtVdNamePdt']; ?></th>
                            <th class="text-right xCNRptColumnHeader"><?php echo $aDataTextRef['tRptRetPdtVdAmount']; ?></th>
                            <th class="text-left xCNRptColumnHeader"><?php echo $aDataTextRef['tRptRetPdtVdUnit']; ?></th>
                        </tr>
                    </thead>
                    <tbody>
                            ...
                            <?php foreach($aDataReport['aRptData'] as $aData){ ?>
                                ...
                                <?php
                                    if($nRowPartID == 0 && $aData["FTXthTnsType"] == "1") { // Grouping Data
                                        $aGrouppingData = array($tXihDocNo,$tDocDate,$tRefIn, $tRsnName, $tUsrName);
                                        ...
                                        for($i = 0;$i < FCNnHSizeOf($aGrouppingData); $i++) {
                                            if(strval($aGrouppingData[$i]) != "N") {
                                                switch($i){
                                                    ...
                                                    case 3 : {
                                                        echo "<td class='xCNRptGrouPing text-left' colspan='2' style='padding: 5px;'>" . $aGrouppingData[$i]. "</td>";
                                                        break;
                                                    }
                                                    default : {
                                                        echo "<td class='xCNRptGrouPing text-left' colspan='2' style='padding: 5px;'>" . $aGrouppingData[$i]. "</td>";
                                ...
                                <?php if($aData['FNRowPartID'] > 0 && $aData["FTXthTnsType"] == "2"){ // Detail Data ?>
                                    <tr>
                                        <td class="text-center xCNRptDetail"><?php echo $aData['FNRowPartID']; ?></td>
                                        <td class="text-left xCNRptDetail"><?php echo $aData['FTPdtCode']; ?>
                                        <td class="text-left xCNRptDetail"><?php echo $aData['FTPdtName']; ?>
                                        <td class="text-right xCNRptDetail"></td>
                                        <td class="text-right xCNRptDetail"></td>
                                        <td class="text-right xCNRptDetail"></td>
                                        <td class="text-right xCNRptDetail"><?php echo number_format($aData['FCXidQty'],$nOptDecimalShow); ?></td>
                                ...
                                <?php   if($nGroupMember==$aData['FNRowPartID']){ ?>
                                    <tr style="border-top: solid 1px #333 !important;">
                                        <td class="text-left xCNRptGrouPing" colspan="6"><?php echo $aDataTextRef['tRptRetPdtVdTotal']; ?></td>

                                        <td class="text-right xCNRptGrouPing"><?php echo number_format($aData['FNSUMQty'],$nOptDecimalShow); ?></td>
                                        <td class="text-left xCNRptGrouPing" ></td>

                                    </tr>
                                <?php     }  ?>
                                <?php
                                    $paFooterSumData = array($aDataTextRef['tRptRetPdtVdTotalReturnValue'], 'N', 'N', 'N', 'N', 'N',

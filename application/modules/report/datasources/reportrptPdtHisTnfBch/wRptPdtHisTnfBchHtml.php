        ...
        <div class="xCNContentReport">
            <div id="odvRptTableAdvance" class="table-responsive">
                <table class="table">
                    <thead>
                        <tr>
                            <th nowrap class="text-left xCNRptColumnHeader" width="20%"><?php echo $aDataTextRef['tRptBchDest'];?></th>
                            <th nowrap class="text-left xCNRptColumnHeader" width="15%"><?php echo $aDataTextRef['tRptTnfFrm'];?></th>
                        ...
                        <tr style="border-bottom: 1px solid black !important">
                            <th nowrap class="text-left xCNRptColumnHeader" style="text-indent: 10%;"><?php echo $aDataTextRef['tRptDocNo'];?></th>
                            <th nowrap class="text-left xCNRptColumnHeader"><?php echo $aDataTextRef['tRptTnfDate'];?></th>
                            <th nowrap class="text-center xCNRptColumnHeader"><?php echo $aDataTextRef['tRptDocRefer'];?></th>
                            <th nowrap class="text-center xCNRptColumnHeader"><?php echo $aDataTextRef['tRptDateRefer'];?></th>
                            ...
                            <th nowrap class="text-center xCNRptColumnHeader"><?php echo $aDataTextRef['tRptQty'];?></th>
                    ...
                    <tbody>
                        <?php if(isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])):?>
                            ...
                            <?php foreach ($aDataReport['aRptData'] as $nKey=>$aValue): ?>
                                <?php
                                    $tFTXthBchTO    = $aValue['FTXthBchTO']; // FTXthBchTO  -- รหัสสาขาปลายทาง
                                    $tFTBchNameTo   = $aValue['FTBchNameTo'];  //FTBchNameTo  --สาขาปลายทาง

                                    $tFTXthBchFrm   = $aValue['FTXthBchFrm'];  //FTXthBchFrm  รหัสโอนจาก
                                    $tFTBchNameFrm  = $aValue['FTBchNameFrm']; //FTBchNameFrm  ชื่อโอนจาก
                            ...
                            <?php
                                if($tFTXthBchTO != ''){
                                    $tFTXthBchTO = '('.$tFTXthBchTO.')';
                                }

                                if($tFTXthBchFrm != ''){
                                    $tFTXthBchFrm = '('.$tFTXthBchFrm.')';
                                }
                                ...
                                $aGrouppingData = array($tFTXthBchTO.' '.$tFTBchNameTo, $tFTXthBchFrm.' '.$tFTBchNameFrm,"N","N","N","N",'N');
                            ...
                            <tr>
                                ...
                                <td class="text-center xCNRptDetail"><?php echo @$aValue['FTPdtName'];?></td>
                                <td class="text-right xCNRptDetail"><?php echo number_format(@$aValue['FCXidQty'],$nOptDecimalShow)?></td>
                                <td class="text-center xCNRptDetail"><?php echo @$aValue['FTPunName'];?></td>
                            </tr>
                            ...
                            <?php
                                ...
                                if($nRowPartID == $nGroupMember){
                                    ...
                                    for($i = 0;$i<FCNnHSizeOf($aSumFooter);$i++){
                                        ...
                                        echo "<td class='xCNRptGrouPing $tClassCss'  style='border-top: dashed 1px #333 !important; ".$tTextInden." '>".$tFooterVal."</td>";
                                    }
                                    echo "</tr>";

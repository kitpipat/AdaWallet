        ...
        <div class="xCNContentReport">
            <div id="odvRptTableAdvance" class="table-responsive">
                <table class="table">
                    <thead>
                        <tr>
                            <th nowrap class="text-left xCNRptColumnHeader" ><?php  echo language('report/report/report', 'tRptBarchName') ?></th>
                            <th nowrap class="text-left xCNRptColumnHeader"><?php  echo language('report/report/report', 'tRptSalTimePrdTmpTimeTime') ?></th>
                            <th nowrap class="text-right  xCNRptColumnHeader" ><?php  echo language('report/report/report', 'tRptQtySale') ?></th>
                            <th nowrap class="text-right  xCNRptColumnHeader" ><?php  echo language('report/report/report', 'tRptSalTimePrdAverageQtySale') ?></th>
                            <th nowrap class="text-right  xCNRptColumnHeader" ><?php  echo language('report/report/report', 'tRptSalTimePrdBillAmount') ?></th>
                            <th nowrap class="text-right  xCNRptColumnHeader" ><?php  echo language('report/report/report', 'tRptSalTimePrdAverageBill') ?></th>
                            <th nowrap class="text-right  xCNRptColumnHeader" ><?php  echo language('report/report/report', 'tRptSales') ?></th>
                            <th nowrap class="text-right  xCNRptColumnHeader" ><?php  echo language('report/report/report', 'tRptSalTimePrdAverageSales') ?></th>
                            <th nowrap class="text-right  xCNRptColumnHeader" ><?php  echo language('report/report/report', 'tRptDiscount') ?></th>
                    ...
                    <tbody>
                        ...
                        <?php
                                    ...
                                    $cSumSubXshBillQty      = number_format($aValue["FCXshBillQty_SubTotal"], $nOptDecimalShow);
                                    $cSumSubFCXsdNet     = number_format($aValue["FCXsdNet_SubTotal"], $nOptDecimalShow);
                                    $cSumSubFCXsdDisChg     = number_format($aValue["FCXsdDisChg_SubTotal"], $nOptDecimalShow);
                                    $cSumSubFCXshGrand      = number_format($aValue["FCXshGrand_SubTotal"], $nOptDecimalShow);

                                    $nPctPerQty     = number_format(($aValue["FCXsdQty"]*100)/$aValue["FCXsdQty_SubTotal"], $nOptDecimalShow);
                                    $nPctByBill     = number_format(($aValue["FCXshBillQty"]*100)/$aValue["FCXshBillQty_SubTotal"], $nOptDecimalShow);
                                    $nPctByAmt      = number_format(($aValue["FCXsdNet"]*100)/$aValue["FCXsdNet_SubTotal"], $nOptDecimalShow);
                                ?>
                        <tr>
                            <!-- Step 2 -->
                            <?php if($tBchCodeGroup != $aValue["FTBchCode"]){
                            ?>
                            <td nowrap class="text-left xCNRptGrouPing"><?php echo '&nbsp;&nbsp;'.$aValue["FTBchName"];?></td>
                            <?php
                            }else {
                            ?>
                            ...
                            <td nowrap class="text-left xCNRptDetail"><?php echo '&nbsp;&nbsp;'.$aValue["FTXshSaleTime"];?></td>
                            <td nowrap class="text-right xCNRptDetail"><?php echo '&nbsp;&nbsp;'.number_format($aValue["FCXsdQty"], $nOptDecimalShow);?></td>
                            <td nowrap class="text-right xCNRptDetail"><?php echo '&nbsp;&nbsp;'.$nPctPerQty;?></td>
                            <td nowrap class="text-right xCNRptDetail"><?php echo '&nbsp;&nbsp;'.number_format($aValue["FCXshBillQty"], $nOptDecimalShow)?></td>
                            <td nowrap class="text-right xCNRptDetail"><?php echo '&nbsp;&nbsp;'.$nPctByBill;?></td>
                            <td nowrap class="text-right xCNRptDetail"><?php echo '&nbsp;&nbsp;'.number_format($aValue["FCXsdNet"], $nOptDecimalShow);?></td>
                            <td nowrap class="text-right xCNRptDetail"><?php echo '&nbsp;&nbsp;'.$nPctByAmt ;?></td>
                            <td nowrap class="text-right xCNRptDetail"><?php echo '&nbsp;&nbsp;'.number_format($aValue["FCXsdDisChg"], $nOptDecimalShow);?></td>
                        ...
                        <?php
                                    ...
                                    $aSumFooter             = array(language('report/report/report', 'tRptTotal'),$nSumSubXsdQty,'N',$cSumSubXshBillQty,'N',$cSumSubFCXsdNet,'N',$cSumSubFCXsdDisChg,$cSumSubFCXshGrand);
                                    ...
                                    $nSumFootXshBillQty      = number_format($aValue["FCXshBillQty_Footer"], $nOptDecimalShow);
                                    $nSumFootXsdNet          = number_format($aValue["FCXsdNet_Footer"], $nOptDecimalShow);
                                    $nSumFootXsdDisChg       = number_format($aValue["FCXsdDisChg_Footer"], $nOptDecimalShow);
                                    $nSumFootXshGrand        = number_format($aValue["FCXshGrand_Footer"], $nOptDecimalShow);
                                    $paFooterSumData         = array($aDataTextRef['tRptTotalFooter'],'N',$nSumFootXsdQty,'N',$nSumFootXshBillQty,'N',$nSumFootXsdNet,'N',$nSumFootXsdDisChg,$nSumFootXshGrand);
                                    $tBchCodeGroup  = $aValue["FTBchCode"];
                                ?>
                        <?php endforeach;?>
                        <?php
                                //Step 5 : สั่ง Summary Footer

        ...
        <div class="xCNContentReport">
            <div id="odvRptTableRPD" class="table-responsive">
                <table class="table" >
                    <thead>
                        <tr>
                            <th class="text-left xCNRptColumnHeader" ><?php echo $aDataTextRef['tRptSalByBranchSeq']; ?></th>
                            <th class="text-left xCNRptColumnHeader" ><?php echo $aDataTextRef['tRptSalByBranchBchCode']; ?></th>
                            <th class="text-left xCNRptColumnHeader" ><?php echo $aDataTextRef['tRptSalByBranchBchName']; ?></th>
                            <th class="text-right xCNRptColumnHeader"><?php echo $aDataTextRef['tRptSalByBranchQtyBill']; ?></th>
                            <th class="text-right xCNRptColumnHeader" ><?php echo $aDataTextRef['tRptSalByBranchGrand']; ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php if(!empty($aDataReport['aRptData'])){ ?>
                            <?php foreach($aDataReport['aRptData'] as $aData){ ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left xCNRptDetail"><?php echo $aData["FTBchCode"]?></td>
                                        <td class="text-left xCNRptDetail"><?php echo $aData['FTBchName']?></td>
                                        <td class="text-right xCNRptDetail"><?php echo number_format($aData['FNSalBillQty'],$nOptDecimalShow)?></td>
                                        <td class="text-right xCNRptDetail"><?php echo number_format($aData['FCXshGrand'],$nOptDecimalShow); ?></td>
                                    </tr>


                                <?php
                                    $paFooterSumData = array($aDataTextRef['tRptTotalFooter'], 'N', 'N',
                                        number_format($aData['FCXrnQty_Footer'], $nOptDecimalShow),
                                        number_format($aData['FCXrcNet_Footer'], $nOptDecimalShow),
                                    );
                                ?>
                            <?php } ?>

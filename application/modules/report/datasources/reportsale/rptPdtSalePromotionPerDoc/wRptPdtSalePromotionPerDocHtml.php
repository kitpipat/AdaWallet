...
<div id="odvRptPdtSalePromotionPerDocHtml">
    <div class="container-fluid xCNLayOutRptHtml">
        ...
        <div class="xCNContentReport">
                ...
                <table class="table">
                    <thead>
                        ...
                        <tr style="border-bottom: 1px solid black !important">
                            <th nowrap class="text-center xCNRptColumnHeader" style="width:15%; text-indent: -70px;"><?php echo $aDataTextRef['tRptPmoDocNo'];?></th>
                            <th nowrap class="text-center xCNRptColumnHeader" style="width:10%; text-indent: -70px;"><?php echo $aDataTextRef['tRptPmoDate'];?></th>
                            <th nowrap class="text-center xCNRptColumnHeader" style="width:15%; text-indent: -70px;"><?php echo $aDataTextRef['tRpePmoBarCode'];?></th>
                            <th nowrap class="text-left xCNRptColumnHeader" style="width:25%; text-indent: 30px;"><?php echo $aDataTextRef['tRptPmoProduct'];?></th>
                    ...
                    <tbody>
                        <?php if(isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])):?>
                            ...
                            <?php foreach ($aDataReport['aRptData'] as $nKey=>$aValue): ?>
                                ...
                                <?php
                                    $aGrouppingData = array($tPmhDocNo,"N","N","N",$tGetTypePmh,"N",$tQtyPer,"N",$nFCXsdNet,$nFCXpdDis,$nFCXsdNetPmt);
                                    if($nRowPartID == 1) {
                                ...
                                <tr>
                                    <td class="text-left xCNRptDetail" style="text-indent: 70px;"><?php echo $aValue["FTXshDocNo"]; ?></td>
                                    <td nowrap class="text-left xCNRptDetail"><?php echo date('d/m/Y',strtotime($aValue['FDXshDocDate'])) ?></td>
                                    <td class="text-left xCNRptDetail" style="text-indent: 20px;"><?php echo $aValue["FTXsdBarCode"]; ?></td>
                                    <td class="text-left xCNRptDetail" style="text-indent: 29px;"><?php echo $aValue["FTPdtName"]; ?></td>
                                ...
                                <?php
                                    ...
                                    $aFooterSumData      = array($aDataTextRef['tRptAdjStkVDTotalFooter'],'N','N','N','N','N',number_format($nFCXsdQty_Footer,$nOptDecimalShow),"N",number_format($nFCXsdNet_Footer,$nOptDecimalShow),number_format($nFCXpdDis_Footer,$nOptDecimalShow),number_format($nFCXsdNetPmt_Footer,$nOptDecimalShow));
                                ?>
            ...
            <?php if (isset($aDataFilter['tShpCodeSelect']) && !empty($aDataFilter['tShpCodeSelect'])) : ?>
                <div class="xCNRptFilterBox">
                    <div class="xCNRptFilter">
                        <label class="xCNRptDisplayBlock"><span class="xCNRptFilterHead"><?php echo $aDataTextRef['tRptShopFrom']; ?> : </span> <?php echo ($aDataFilter['bShpStaSelectAll']) ? $aDataTextRef['tRptAll'] : $aDataFilter['tShpCodeSelect']; ?></label>
                    </div>
                </div>
            <?php endif; ?>

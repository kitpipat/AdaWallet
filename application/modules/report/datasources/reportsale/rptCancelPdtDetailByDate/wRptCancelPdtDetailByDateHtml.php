        ...
        <div class="xCNContentReport">
            <div id="odvRptTableRPD" class="table-responsive">
                <table class="table" >
                    <thead>
                        <tr>
                            <th class="text-left xCNRptColumnHeader" ><?php echo $aDataTextRef['tRptRPDsequen']; ?></th>
                            <th class="text-left xCNRptColumnHeader" ><?php echo $aDataTextRef['tRptRPDDate']; ?></th>
                            <th class="text-left xCNRptColumnHeader"><?php echo $aDataTextRef['tRptRPDDocNo']; ?></th>
                            <th class="text-left xCNRptColumnHeader" ><?php echo $aDataTextRef['tRptPdtCode']; ?></th>
                            <th class="text-left xCNRptColumnHeader" ><?php echo $aDataTextRef['tRptPdtName']; ?></th>
                            <th class="text-center xCNRptColumnHeader" ><?php echo $aDataTextRef['tRptCabinetnumber']; ?></th>
                            <th class="text-left xCNRptColumnHeader" ><?php echo $aDataTextRef['tRptUnit']; ?></th>
                            <th class="text-left xCNRptColumnHeader" ><?php echo $aDataTextRef['tRptRPDRmkCancel']; ?></th>
                            <th class="text-left xCNRptColumnHeader" ><?php echo $aDataTextRef['tRptRPDCancel']; ?></th>
                            <th class="text-left xCNRptColumnHeader" ><?php echo $aDataTextRef['tRptRPDApprov']; ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php if(!empty($aDataReport['aRptData'])){ ?>
                            <?php foreach($aDataReport['aRptData'] as $aData){ ?>
                                    ...
                                    <tr>
                                        <td class="text-left xCNRptDetail"><?php echo $aData['RowID']; ?></td>
                                        <td class="text-left xCNRptDetail"><?php echo date("d/m/Y",strtotime($aData['FDXihDocDate']));  ?></td>
                                        <td class="text-left xCNRptDetail"><?php echo $aData["FTXihDocNo"]?></td>
                                        <td class="text-left xCNRptDetail"><?php echo $aData['FTPdtCode']?></td>
                                        <td class="text-left xCNRptDetail"><?php echo $aData['FTXidPdtName']?></td>
                                        <td class="text-right xCNRptDetail"><?php echo number_format($aData['FCXidQty'],2); ?></td>
                                        <td class="text-left xCNRptDetail" ><?php echo $aData['FTPunName']; ?></td>
                                        <td class="text-left xCNRptDetail"><?php echo $aData['FTRsnName']; ?></td>
                                        <td class="text-left xCNRptDetail"><?php echo $aData['FTUsrVoidName']; ?></td>
                                        <td class="text-left xCNRptDetail"><?php echo $aData['FTUsrAprvName']; ?></td>
                                    </tr>


                                <?php
                                    $paFooterSumData = array($aDataTextRef['tRptTotalFooter'], 'N', 'N', 'N', 'N',
                                        number_format($aData['FCXidQty_Footer'], 2),
                                        'N', 'N','N','N'
                                    );
                                ?>
                            <?php } ?>

    ...
    <div class="container-fluid xCNLayOutRptHtml">
        ...
        <div class="xCNContentReport">
            ...
            <?php if ((isset($aDataFilter['tWahNameFrom']) && !empty($aDataFilter['tWahNameFrom'])) && (isset($aDataFilter['tWahNameTo']) && !empty($aDataFilter['tWahNameTo']))
              ...
              <!-- ============================ ฟิวเตอร์ข้อมูล สถานะสินค้าคงคลัง ============================ -->
                <?php if (isset($aDataFilter['tRptStaBalQty']) && !empty($aDataFilter['tRptStaBalQty'])) : ?>
                    <div class="xCNRptFilterBox">
                        <div class="xCNRptFilter">
                            <label class="xCNRptDisplayBlock"><span class="xCNRptFilterHead"><?php echo $aDataTextRef['tRptStaBalQtyTitle']; ?> : </span> <?php echo  $aDataTextRef['tRptStaBalQty'.$aDataFilter['tRptStaBalQty']]; ?></label>
                        </div>
                    </div>
                <?php endif; ?>
        </div>

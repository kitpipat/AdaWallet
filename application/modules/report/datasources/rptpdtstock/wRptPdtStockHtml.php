                    ...
                    <tbody>
                        <?php if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) : ?>
                            ...
                            <?php foreach ($aDataReport['aRptData'] as $nKey => $aValue) : ?>
                                ...
                                //     echo "<tr>";
                                //     for ($i = 0; $i < count($aGrouppingDataWah); $i++) {
                                ...
                                // $aGrouppingDataPdt  = array($tPdtCode, $tPdtName);
                                ...
                                //     for ($i = 0; $i < count($aGrouppingFootDataWah); $i++) {
                                ...
                                //     ];
                                //     echo "<tr style='border-bottom:1px solid black !important'>";
                                //     for ($i = 0; $i < count($aGrouppingFootDataBch); $i++) {
                                ...
                                $nFCStkQtyMonEnd_Footer   = number_format($aValue["FCStkQtyMonEnd_Footer"], $nOptDecimalShow);
                                $nFCStkQtyIn_Footer   = number_format($aValue["FCStkQtyIn_Footer"], $nOptDecimalShow);
                                $nFCStkQtyOut_Footer   = number_format($aValue["FCStkQtyOut_Footer"], $nOptDecimalShow);
                                $nFCStkQtySale_Footer   = number_format($aValue["FCStkQtySale_Footer"], $nOptDecimalShow);
                                $nFCStkQtyAdj_Footer   = number_format($aValue["FCStkQtyAdj_Footer"], $nOptDecimalShow);
                                $nFCStkQtyBal_Footer   = number_format($aValue["FCStkQtyBal_Footer"], $nOptDecimalShow);
                                $paFooterSumData    = array($aDataTextRef['tRptTotalFooter'], 'N', $nFCStkQtyMonEnd_Footer, $nFCStkQtyIn_Footer, $nFCStkQtyOut_Footer, $nFCStkQtySale_Footer,$nFCStkQtyAdj_Footer, $nFCStkQtyBal_Footer);
                                ?>
                            <?php endforeach; ?>

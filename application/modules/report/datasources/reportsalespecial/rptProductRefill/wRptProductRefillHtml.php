                ...
                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <label class="xCNRptTitle"><?php echo $aDataTextRef['tRptTitleProductRefill']; ?></label>
                            </div>
                        </div>
                    </div>
        ...
        <div class="xCNContentReport">
            <div id="odvRptTableAdvance" class="table-responsive">
                <table class="table">
                    <thead>
                        <tr>
                            <th  class="text-left xCNRptColumnHeader" width="7%"><?php echo @$aDataTextRef['tRptProductRefillBranch'];?></th>
                            <th  class="text-left xCNRptColumnHeader" width="7%"><?php echo @$aDataTextRef['tRptProductRefillShop'];?></th>
                            <th  class="text-center xCNRptColumnHeader"  width="7%"><?php echo @$aDataTextRef['tRptProductRefillContainer'];?></th>
                            <th  class="text-left xCNRptColumnHeader"  width="7%"><?php echo @$aDataTextRef['tRptProductRefillTosVD'];?></th>
                            <th  class="text-center xCNRptColumnHeader"  width="7%"><?php echo @$aDataTextRef['tRptProductRefillDocNo'];?></th>
                            <th  class="text-center xCNRptColumnHeader"  width="7%"><?php echo @$aDataTextRef['tRptProductRefillDate'];?></th>
                            <th  class="text-left xCNRptColumnHeader"  width="7%" ><?php echo @$aDataTextRef['tRptProductRefillFromsWah'];?></th>
                            <th  class="text-left xCNRptColumnHeader"  width="7%"><?php echo @$aDataTextRef['tRptProductRefillChannelgroup'];?></th>
                            <th  class="text-left xCNRptColumnHeader"  width="7%"><?php echo @$aDataTextRef['tRptProductRefillID'];?></th>
                            <th  class="text-left xCNRptColumnHeader"  width="7%"><?php echo @$aDataTextRef['tRptProductRefillName'];?></th>
                            <th  class="text-right xCNRptColumnHeader"  width="7%"><?php echo @$aDataTextRef['tRptProductRefillfloor'];?></th>
                            <th  class="text-right xCNRptColumnHeader"  width="7%"><?php echo @$aDataTextRef['tRptProductRefillspiral'];?></th>
                            <th  class="text-right xCNRptColumnHeader"  width="7%"><?php echo @$aDataTextRef['tRptProductRefillAmounttofill'];?></th>
                        </tr>
                    </thead>
                    <tbody> 
                    <?php
                     if(!empty($aDataReport['aRptData'])){
                         ...
                         foreach($aDataReport['aRptData'] as $k => $aValue){
                            ...
                            <tr>
                                <td class="text-left xCNRptDetail"><?php echo $aValue['FTBchName'].@$tTypeCode;?></td>
                                <td class="text-left xCNRptDetail"><?php echo $aValue['FTShpName'];?></td>
                                <td class="text-left xCNRptDetail"><?php echo $aValue['FTPosName'];?></td>
                                <td class="text-left xCNRptDetail"><?php echo $aValue['FTWahName'];?></td>
                                <td class="text-left xCNRptDetail"><?php echo $aValue['FTTxnDocRefNo'];?></td>
                                <td class="text-center xCNRptDetail "><?php echo date('d/m/Y',strtotime($aValue['FDDocDate'])); ?></td>
                                <td class="text-left xCNRptDetail" ><?php echo $aValue['FTXthWhToName'];?></td>
                                <td class="text-left xCNRptDetail" ><?php echo $aValue['FNCabSeq'];?></td>
                                <td class="text-left xCNRptDetail"><?php echo $aValue['FTPdtCode'];?></td>
                                <td class="text-left xCNRptDetail"><?php echo $aValue['FTPdtName'];?></td>
                                <td class="text-right xCNRptDetail"><?php echo $aValue['FNLayRow'];?></td>
                                <td class="text-right xCNRptDetail"><?php echo $aValue['FNLayCol'];?></td>
                                <td class="text-right xCNRptDetail"><?php echo number_format($aValue['FCXtdQty'], $nOptDecimalShow);?></td>
                            </tr>
                            <?php 
                                      $nPageNo    = $aDataReport["aPagination"]["nDisplayPage"];
                                      $nTotalPage = $aDataReport["aPagination"]["nTotalPage"];

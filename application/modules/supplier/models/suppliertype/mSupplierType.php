...
class mSupplierType extends CI_Model {
        ...
        try{
            ...
            $tSQL       = "SELECT c.* FROM(
                                SELECT  ROW_NUMBER() OVER(ORDER BY FDCreateOn DESC , rtStyCode DESC) AS rtRowID,* FROM
                                    ...
                                    LEFT JOIN (SELECT DISTINCT FTStyCode,FTAgnCode FROM TCNMSpl WITH(NOLOCK)) SPL ON SPL.FTStyCode = STY.FTStyCode
                                    WHERE 1=1 ";

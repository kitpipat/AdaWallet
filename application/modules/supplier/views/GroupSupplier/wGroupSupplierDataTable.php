                        ...
                        <?php foreach($aSgpDataList['raItems'] AS $nKey => $aValue):?>
                            ...
                            <td class="text-center">
                                ...
                                <td class="text-center <?=$tDisableTD?>">
                                    <!-- เปลี่ยน -->
                                    <img class="xCNIconTable <?php echo $tDisableImg; ?>" src="<?php echo  base_url().'/application/modules/common/assets/images/icons/delete.png'?>" onClick="JSoGroupSupplierDel('<?php echo $aValue['rtSgpCode']?>','<?php echo $aValue['rtSgpName']?>')">
                                </td>
                                <td class="text-center">
                                    <!-- เปลี่ยน -->

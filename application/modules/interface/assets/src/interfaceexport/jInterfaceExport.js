        ...
        $.ajax({
            ...
            success: function(tResult){
                ...
                if(aResult.tHost == '' || aResult.tPort == ''  || aResult.tPassword == '' || aResult.tUser == '' || aResult.tVHost == ""){
                    ...
                    var tPasswordCon = JCNtAES128DecryptData($('#oetInterfaceExporttLK_SAPDBPwd').val(), '5YpPTypXtwMML$u@', 'zNhQ$D%arP6U8waL');
                    $.ajax({
                        type    : "POST",
                        url     : "interfaceexportAction",
                        data    : $('#ofmInterfaceExport').serialize()+"&ptTypeEvent="+'confirm'+'&tPassword='+tPassword+'&tPasswordCond='+tPasswordCon,
                        cache   : false,
                        Timeout : 0,
                        success: function(tResult){
                            console.log(tResult);

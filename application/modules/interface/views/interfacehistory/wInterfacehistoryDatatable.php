                    ...
                    <?php if ($aDataList['rtCode'] == 1) : ?>
                        <?php foreach ($aDataList['raItems'] as $key => $aValue) { ?>
                            <tr>
                                ...
                                <?php if ($aValue['FTLogType']=="1") { ?>
                                  <td class="text-center"><?php if($aValue['FDLogCreateIm']!=""){ echo date('Y-m-d', strtotime($aValue['FDLogCreateIm'])); } ?></td>
                                  <td class="text-center"><?php if($aValue['FDLogCreateIm']!=""){ echo date('H:i:s', strtotime($aValue['FDLogCreateIm'])); } ?></td>
                                <?php } ?>
                                <?php if ($aValue['FTLogType']=="2") { ?>
                                  <td class="text-center"><?php if($aValue['FDLogCreate']!=""){ echo date('Y-m-d', strtotime($aValue['FDLogCreate'])); } ?></td>
                                  <td class="text-center"><?php if($aValue['FDLogCreate']!=""){ echo date('H:i:s', strtotime($aValue['FDLogCreate'])); } ?></td>
                                <?php } ?>

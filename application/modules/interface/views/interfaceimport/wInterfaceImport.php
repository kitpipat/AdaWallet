...
<input name="oetInterfaceImporttLK_SAPDBSever" id="oetInterfaceImporttLK_SAPDBSever" type="hidden" value="<?=$aConnect['tLK_SAPDBSever']?>">
<input name="oetInterfaceImporttLK_SAPDBName" id="oetInterfaceImporttLK_SAPDBName" type="hidden" value="<?=$aConnect['tLK_SAPDBName']?>">
<input name="oetInterfaceImporttLK_SAPDBPort" id="oetInterfaceImporttLK_SAPDBPort" type="hidden" value="<?=$aConnect['tLK_SAPDBPort']?>">
<input name="oetInterfaceImporttLK_SAPDBUsr" id="oetInterfaceImporttLK_SAPDBUsr" type="hidden" value="<?=$aConnect['tLK_SAPDBUsr']?>">
<input name="oetInterfaceImporttLK_SAPDBPwd" id="oetInterfaceImporttLK_SAPDBPwd" type="hidden" value="<?=$aConnect['tLK_SAPDBPwd']?>">
						...
						<table id="otbCtyDataList" class="table table-striped"> <!-- เปลี่ยน -->
							...
							<?php if(!empty($aDataMasterImport)){
								...
								<tr>
									...
									<td align="center">
										<input type="checkbox" class="progress-bar-chekbox" name="ocmINMImport[<?=$aData['FNApiGrpSeq']?>]" value="<?=$aData['FNApiGrpSeq']?>" checked idpgb="xWINM<?=$aData['FTApiCode']?>TextDisplay"  >
									</td>

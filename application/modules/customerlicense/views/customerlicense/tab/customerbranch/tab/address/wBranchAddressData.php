        ...
        <div class="demo-button xCNBtngroup" style="width:100%;">
            <?php if($aAlwBranchAddress['tAutStaFull'] == 1 || ($aAlwBranchAddress['tAutStaAdd'] == 1 || $aAlwBranchAddress['tAutStaEdit'] == 1)) : ?>
                <div id="odvBranchAddressBtnGrpInfo">
                    <button id="obtBranchAddressCallPageAdd"  onclick="JSvTBACallPageBchAddrAdd();" class="xCNBTNPrimeryPlus" type="button">+</button>
                </div>
            <?php endif; ?>
            <div id="odvBranchAddressBtnGrpAddEdit">
                <div class="demo-button xCNBtngroup" style="width:100%;">
                    ...
                    <?php if($aAlwBranchAddress['tAutStaFull'] == 1 || ($aAlwBranchAddress['tAutStaAdd'] == 1 || $aAlwBranchAddress['tAutStaEdit'] == 1)) : ?>
                        <button id="obtBranchAddressSave"  onclick="JSxTBAAddUpdateEvent();" type="button" class="btn" style="background-color:#179BFD; color:white;">

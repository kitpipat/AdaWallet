                    ...
                    <?php if ($aDataList['rtCode'] == 1): ?>
                        ...
                        ?>
                            <tr class="text-center xCNTextDetail2 otrUser" id="otrUser<?= $key ?>" data-code="<?= $aValue['rtUsrCode'] ?>" data-name="<?= $aValue['rtUsrName'] ?>">
                                <?php if ($aAlwEventUser['tAutStaFull'] == 1 || ($aAlwEventUser['tAutStaAdd'] == 1 || $aAlwEventUser['tAutStaEdit'] == 1)) : ?>
                                    <td class="text-center">
                                        <label class="fancy-checkbox">
                                            <input id="ocbListItem<?= $key ?>" type="checkbox" class="ocbListItem" name="ocbListItem[]" <?php if( $aValue['rtUsrCode'] == $this->session->userdata("tSesUserCode") ){ echo "disabled"; } ?> >
                                            <span class="<?php if( $aValue['rtUsrCode'] == $this->session->userdata("tSesUserCode") ){ echo "xCNDocDisabled"; } ?>" >&nbsp;</span>
                                        </label>
                                    </td>
                                <?php endif; ?>
                                <td class="text-center">
                                ...
                                <?php if ($aAlwEventUser['tAutStaFull'] == 1 || ($aAlwEventUser['tAutStaAdd'] == 1 || $aAlwEventUser['tAutStaEdit'] == 1)) : ?>
                                    <td>
                                        <img class="xCNIconTable xCNIconDel <?php if( $aValue['rtUsrCode'] == $this->session->userdata("tSesUserCode") ){ echo "xCNDocDisabled"; } ?> " src="<?php echo base_url() . '/application/modules/common/assets/images/icons/delete.png' ?>" > <!-- onClick="JSnUserDel('<?= $nCurrentPage ?>','<?= $aValue['rtUsrName'] ?>','<?php echo $aValue['rtUsrCode'] ?>','<?php echo language('common/main/main', 'tBCHYesOnNo') ?>')" -->
                                    </td>
                                <?php endif; ?>
                                <?php if ($aAlwEventUser['tAutStaFull'] == 1 || ($aAlwEventUser['tAutStaAdd'] == 1 || $aAlwEventUser['tAutStaEdit'] == 1)) : ?>
                                    <td>

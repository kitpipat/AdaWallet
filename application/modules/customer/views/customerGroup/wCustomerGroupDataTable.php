                    ...
                    <?php foreach($aDataList['raItems'] AS $key=>$aValue){ ?>
                        ...
                        <td class="text-center">
								<label class="fancy-checkbox">
									<input id="ocbListItem<?=$key?>" type="checkbox" class="ocbListItem" <?php echo $tDisabledItem; ?> name="ocbListItem[]" onchange="JSxCstGrpVisibledDelAllBtn(this, event)">
                            ...
                            <td  class="<?=$tDisableTD?>">
                                <img class="xCNIconTable <?php echo $tDisableImg; ?>" src="<?php echo  base_url().'/application/modules/common/assets/images/icons/delete.png'?>" onClick="JSaCstGrpDelete(this, event)" title="<?php echo language('customer/customerGroup/customerGroup', 'tCstGrpTBDelete'); ?>">
                            </td>
                            <td>

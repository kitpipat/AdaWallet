            ...
            <div class="row xCNavRow" style="width:inherit;">
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                    <ol id="oliSMTSALMenuNav" class="breadcrumb">
                        <?php FCNxHADDfavorite('augAuto');?>
                        <li id="oliSMTSALTitle" style="cursor:pointer;" datenow="<?=date('Y-m-d')?>"><?php echo language('tool/tool/tool', 'tlogUPGTitle');?></li>
                    </ol>
                </div>
        ...
        <div class="panel panel-headline">
                                    ...
                                    <ul class="nav" role="tablist" data-typetab="main" data-tabtitle="odvSMTSALContentPage">
                                        <li id="oliSMTInfo1" class="xWMenu active">
                                            <a  
                                                ...
                                                onclick="JSvUPGMain()"
                                                aria-expanded="true"><?=language('tool/tool/tool', 'tlogUPGTab1');?></a>
                                        </li>
                                        ...
                                        <li id="oliSMTInfo2" class="xWMenu" data-typetab="main" data-tabtitle="odvSMTMQInformation">
                                            <a 
                                                ...
                                                onclick="JSvDPYMain()"
                                                aria-expanded="false"><?=language('tool/tool/tool', 'tlogUPGTab2')?></a>
                                        </li>
                                        <?php } ?>
            ...
            <div class="row">
                <div class="tab-content">
                    <div id="odvUPGAutoConent"  class="tab-pane fade active in"></div>
                    <div id="odvDPYConent"  class="tab-pane fade"></div>
                </div>
            </div>
        </div>
    </div>

...
class Upgrade_controller extends MX_Controller {
    ...
    */
    ...
    public function __construct() {
        $this->load->model('tool/upgrade/Upgrade_model');
        parent::__construct();
    }
    ...
    public function index(){
        ...
        $this->load->view('tool/upgrade/wUpGrade');
    }
    ...
    // Return : String View
    // Return Type : View
    public function FSvCUPGMainPage(){
        ...
        $this->load->view('tool/upgrade/wUpGradeMain',$aDataConfigView);
    }



    public function FSvCUPGDataTable(){
        ...
        $aListData = array(
            'aTotalSaleByBranchData' => $this->Upgrade_model->FSaMUPGDataTable($aData),
            'nPage'         => $nPage,
        );
        // echo '<pre>';
        //     print_r($aListData['aTotalSaleByBranchData']);
        // echo '<pre>';
        // die();
        $this->load->view('tool/upgrade/wUpGradeDataTable',$aListData);

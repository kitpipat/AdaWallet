            ...
            <table class="table table-striped">
                <thead>
                    <tr class="xCNCenter">
                        ...
                        <?php if(!$bIsView) { ?>
                        <th class="xCNTextBold"><?=language('company/smart_locker_adjust_status/smartlockeradjsta', 'tSMLKAdjStaDelete')?></th>
                        <?php } ?>
                    </tr>
                </thead>
                <tbody>
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="xWPage btn-toolbar pull-right"> <!-- เปลี่ยนชื่อ Class เป็นของเรื่องนั้นๆ --> 
            ...
            <button onclick="JSvSMLKAdjStaTempDataTableClickPage('previous')" class="btn btn-white btn-sm" <?php echo $tDisabledLeft ?>> <!-- เปลี่ยนชื่อ Onclick เป็นของเรื่องนั้นๆ --> 
            ...
            <button onclick="JSvSMLKAdjStaTempDataTableClickPage('next')" class="btn btn-white btn-sm" <?php echo $tDisabledRight ?>> <!-- เปลี่ยนชื่อ Onclick เป็นของเรื่องนั้นๆ --> 

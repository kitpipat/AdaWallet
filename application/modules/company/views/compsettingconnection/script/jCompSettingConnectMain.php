<script type="text/javascript">
        ...
        $('#ofmAddEditCompSettingConnect').validate().destroy();
            ...
            $('#ofmAddEditCompSettingConnect').validate({
                ...
                rules: {
                    ...
                    //MQReport
                    oetCompMQWalletUsrAccount : { "required": {} },
                    oetCompMQWalletPassword   : { "required": {} },
    ...
    //Return Type: -
    function JSxCompSettingConnectDelete(ptUrlType,ptUrlAddress,ptUrlID,tYesOnNo,tUrlKey){

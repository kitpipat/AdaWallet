                            ...
                            ?>
                                ...
                                <?php if($aAlwEventCompSettingCon['tAutStaFull'] == 1 || $aAlwEventCompSettingCon['tAutStaDelete'] == 1 ) : ?>
                                    <td nowrap class="text-center">
                                        <img class="xCNIconTable" src="<?php echo  base_url().'/application/modules/common/assets/images/icons/delete.png'?>" onClick="JSxCompSettingConnectDelete('<?php echo $aValue['FNUrlType']?>','<?php echo $aValue['FTUrlAddress']?>','<?php echo $aValue['FNUrlID']?>','<?php echo language('common/main/main','tBCHYesOnNo')?>','<?php echo $aValue['FTUrlKey']?>')">
                                    </td>
                                <?php endif;?>
                                <?php if($aAlwEventCompSettingCon['tAutStaFull'] == 1 || ($aAlwEventCompSettingCon['tAutStaEdit'] == 1 || $aAlwEventCompSettingCon['tAutStaRead'] == 1)) : ?>
                                    <td nowrap class="text-center">

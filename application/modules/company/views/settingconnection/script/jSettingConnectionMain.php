<script type="text/javascript">
    ...
    //Return : View
    //Return Type : View
    function JSvCallPageBchSettingConnectEdit(ptUrlID,ptBchCode){
    ...
    //Return Type: -
    function JSxBchSettingConnectDelete(ptUrlType,ptUrlAddress,ptUrlID,tYesOnNo,ptUrlRefID,ptURLKey){

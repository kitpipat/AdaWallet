                                ...
                                >
                                    ...
                                    <?php 
                                        switch ($aValue['FNUrlType']) {
                                            ...
                                            break;
                                            case 17: // API2FNWallet
                                                $tStaUrlType  = language('company/settingconnection/settingconnection','MQ');  
                                            break;
                                            default: // default URL
                                                $tStaUrlType  = language('company/settingconnection/settingconnection','tBchUrlType');
                                        }
                                    ...
                                    <?php if($aAlwEventBchSettingCon['tAutStaFull'] == 1 || $aAlwEventBchSettingCon['tAutStaDelete'] == 1 ) : ?>
                                        <td nowrap class="text-center">
                                            <img class="xCNIconTable" src="<?php echo  base_url().'/application/modules/common/assets/images/icons/delete.png'?>" onClick="JSxBchSettingConnectDelete('<?php echo $aValue['FNUrlType']?>','<?php echo $aValue['FTUrlAddress']?>','<?php echo $aValue['FNUrlID']?>','<?php echo language('common/main/main','tBCHYesOnNo')?>','<?=$aValue['FTUrlRefID']?>','<?=$aValue['FTUrlKey']?>')">
                                        </td>
                                    <?php endif;?>

                                    <?php if($aAlwEventBchSettingCon['tAutStaFull'] == 1 || ($aAlwEventBchSettingCon['tAutStaEdit'] == 1 || $aAlwEventBchSettingCon['tAutStaRead'] == 1)) : ?>
                                        <td nowrap class="text-center">
                                            <img class="xCNIconTable xWIMGShpShopEdit" src="<?=base_url().'/application/modules/common/assets/images/icons/edit.png'?>" onClick="JSvCallPageBchSettingConnectEdit('<?=$aValue['FNUrlID']?>','<?=$aValue['FTUrlRefID']?>');">
                                        </td>
                                    <?php endif;?>
                                </tr>
                            <?php } ?>

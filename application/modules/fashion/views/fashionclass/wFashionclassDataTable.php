            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th class="xCNTextBold text-center"><?php echo language('fashion/fashionclass/fashionclass', 'tFashionClassCode'); ?></th>
                        <th class="xCNTextBold text-center"><?php echo language('fashion/fashionclass/fashionclass', 'tFashionClassName'); ?></th>
                        <!-- <th class="xCNTextBold text-center"><?php echo language('fashion/fashionclass/fashionclass', 'tFashionClassAgency'); ?></th> -->
                ...
                <tbody id="odvRGPList">
                    <?php if ($aDataList['rtCode'] == 1) : ?>
                        <?php foreach ($aDataList['raItems'] as $key => $aValue) { ?>
                            ...
                            $tOnClickDel    = " onClick=\"JSaFashionClassDelete('" . $nCurrentPage . "','" . $aValue['rtClsCode'] . "','" . $aValue['rtClsName'] . "')\" ";
                            $tClassDel      = "";
                            $tDisabledDel   = "";

                            ?>
                            <tr class="text-center xCNTextDetail2 xWChnItems" data-key="<?php echo $key; ?>" data-clscode="<?php echo $aValue['rtClsCode']; ?>" ">
                                ...
                                <td class="text-left otdChnCode"><?php echo $aValue['rtClsCode']; ?></td>
                                <td class="text-left"><?php echo $aValue['rtClsName']; ?></td>
                                ...
                                <td>
                                    <img class="xCNIconTable" src="<?php echo  base_url() . '/application/modules/common/assets/images/icons/edit.png' ?>" onClick="JSvCallPageFashionClassEdit('<?php echo $aValue['rtClsCode']; ?>')" title="<?php echo language('common/main/main', 'tEdit'); ?>">
                                </td>
                            </tr>
                        <?php } ?>
                    <?php else : ?>
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="xWPageGrp btn-toolbar pull-right">
            ...
            <button onclick="JSvFashionClassClickPage('previous')" class="btn btn-white btn-sm" <?php echo $tDisabledLeft ?>>
            ...
            <?php for ($i = max($nPage - 2, 1); $i <= max(0, min($aDataList['rnAllPage'], $nPage + 2)); $i++) { ?>
                ...
                ?>
                <!-- เปลี่ยนชื่อ Onclick เป็นของเรื่องนั้นๆ -->
                <button onclick="JSvFashionClassClickPage('<?php echo $i ?>')" type="button" class="btn xCNBTNNumPagenation <?php echo $tActive ?>" <?php echo $tDisPageNumber ?>><?php echo $i ?></button>
            <?php } ?>
            ...
            <button onclick="JSvFashionClassClickPage('next')" class="btn btn-white btn-sm" <?php echo $tDisabledRight ?>>
                <!-- เปลี่ยนชื่อ Onclick เป็นของเรื่องนั้นๆ -->
...
<div class="modal fade" id="odvModalDelFashionClass">
